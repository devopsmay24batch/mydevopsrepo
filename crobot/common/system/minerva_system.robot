...
META_STRESS_COM_TCG1_00_Precondition_Check_Test
    ...
    [Tags]  META_STRESS_COM_TCG1_00_Precondition_Check_Test 
...
META_STRESS_COM_TCG1_02_FPGA_PCIE_Bus_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG1_02_FPGA_PCIE_Bus_Stress_Test  batch1  test2
...
META_STRESS_COM_TCG1_03_OpenBMC_Utility_Stability_Test
    ...
    [Tags]  META_STRESS_COM_TCG1_03_OpenBMC_Utility_Stability_Test  test3  minerva  batch1
...
META_STRESS_COM_TCG1_05_COMe_NVMe_SSD_RW_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG1_05_COMe_NVMe_SSD_RW_Stress_Test  common   test5   minerva  batch1
    Log Info  ===== Start of META_STRESS_COM_TCG1_05_COMe_NVMe_SSD_RW_Stress_Test =====
    Set Testcase Timeout  ${Timeout10000}
    #Set Global Variable     ${StressLoopTime1800}   60
    set nvme stress loop time  ${StressLoopTime120}
    switch to centos diag tool
...
META_STRESS_COM_TCG1_07_BMC_And_CPU_OOB_Link_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG1_07_BMC_And_CPU_OOB_Link_Stress_Test  common  test7   batch1
    Log Info  ===== Start of META_STRESS_COM_TCG1_07_BMC_And_CPU_OOB_Link_Stress_Test =====
    Set Testcase Timeout  ${Timeout10000}
    #Set Global Variable     ${StressLoopTime900}    60
    set bmc cpu link stress loop time  ${StressLoopTime5}
    switch to centos diag tool
...
META_STRESS_COM_TCG1_08_BMC_And_CPU_Internal_USB_Network_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG1_08_BMC_And_CPU_Internal_USB_Network_Stress_Test  test8  batch1
...
META_STRESS_COM_TCG1_10_COMe_Memory_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG1_10_COMe_Memory_Stress_Test  test10
    Log Info  ===== Start of META_STRESS_COM_TCG1_10_COMe_Memory_Stress_Test =====
    #Set Testcase Timeout  ${Timeout8000}
    #Set Global Variable     ${StressLoopTime900}    60
    set come memory stress loop time  ${StressLoopTime120}
    switch to centos
...
META_STRESS_COM_TCG1_11_COMe_CPU_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG1_11_COMe_CPU_Stress_Test  common  test11
    Log Info  ===== Start of META_STRESS_COM_TCG1_11_COMe_CPU_Stress_Test =====
    #Set Testcase Timeout  ${Timeout8000}
    #Set Global Variable     ${StressLoopTime900}    60
    set cpu stress loop time  ${StressLoopTime120}
    switch to centos
    Step  1  check_unidiag_system_versions  DUT
    Step  2  check_system_cpu_stress  DUT
    Step  3  exit unidiag interface  DUT
...
META_STRESS_COM_TCG1_12_OpenBMC_Memory_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG1_12_OpenBMC_Memory_Stress_Test  common  th5  test12  batch1
...
META_STRESS_COM_TCG1_13_OpenBMC_I2C_Bus_Scan_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG1_13_OpenBMC_I2C_Bus_Scan_Stress_Test  test13  th5  batch1
...
META_STRESS_COM_TCG1_14_TPM_Module_Access_Stress_test
    ...
    [Tags]  META_STRESS_COM_TCG1_14_TPM_Module_Access_Stress_test  test14  minerva  batch1
    Log Info  ===== Start of META_STRESS_COM_TCG1_14_TPM_Module_Access_Stress_test =====
    Set Testcase Timeout  ${Timeout4500}
    Set Global Variable     ${MaxRepeatCount5}    
    FOR    ${INDEX}    IN RANGE    1   2
       Step  1  run tpm test  DUT 
