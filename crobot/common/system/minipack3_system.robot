...
META_STRESS_COM_TCG1_00_Precondition_Check_Test
    ...
    [Tags]  META_STRESS_COM_TCG1_00_Precondition_Check_Test  meta_stress  wedge400c  wedge400  minipack31
...
META_STRESS_COM_TCG1_01_Sensor_Reading_Stress-High_Loading
    ...
    [Tags]  META_STRESS_COM_TCG1_01_Sensor_Reading_Stress-High_Loading   
    ...
    minipack3 run sensor reading high loading stress test     #for mp2
...
META_STRESS_COM_TCG1_02_FPGA_PCIE_Bus_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG1_02_FPGA_PCIE_Bus_Stress_Test  common   test2 
    ...
    Step  3  exit unidiag interface  DUT
    Log Info  ===== End of META_STRESS_COM_TCG1_02_FPGA_PCIE_Bus_Stress_Test =====
    [Teardown]  Run Keyword If Test Failed  exit unidiag interface  DUT
...
META_STRESS_COM_TCG1_03_OpenBMC_Utility_Stability_Test
    ...
    [Tags]  META_STRESS_COM_TCG1_03_OpenBMC_Utility_Stability_Test  test3  minipack3  
    ...
    FOR    ${INDEX}    IN RANGE    1   ${MaxRepeatCount5}
       switch to openbmc check tool
       Step  1  run openbmc utility test   DUT  ${fw_util_tool}  ${fw_util_optionStr}
    END 
...
META_STRESS_COM_TCG1_04_IPMI_Interface_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG1_04_IPMI_Interface_Stress_Test  minipack3  test4
    Log Info  ===== Start of META_STRESS_COM_TCG1_04_IPMI_Interface_Stress_Test =====
    #Set Testcase Timeout  ${Timeout8000}
    #Set Global Variable     ${MaxRepeatCount100}    1
    set ipmi test cycles    ${MaxRepeatCount20}
    switch to centos diag tool
    minipack2 run ipmi command stress test    #for minerva
...
META_STRESS_COM_TCG1_05_COMe_NVMe_SSD_RW_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG1_05_COMe_NVMe_SSD_RW_Stress_Test  common   test5   minipack3
...
META_STRESS_COM_TCG1_06_Loopback_EEPROM_Access_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG1_06_Loopback_EEPROM_Access_Stress_Test  meta_stress   test6
...
META_STRESS_COM_TCG1_07_BMC_And_CPU_OOB_Link_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG1_07_BMC_And_CPU_OOB_Link_Stress_Test  common  test7   minipack3
    ...
    set bmc cpu link stress loop time  ${StressLoopTime120}
    switch to centos diag tool
    FOR    ${INDEX}    IN RANGE    1   ${MaxRepeatCount5}
       minipack3 run oob test  DUT
       exit unidiag interface  DUT
    END
...
META_STRESS_COM_TCG1_08_BMC_And_CPU_Internal_USB_Network_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG1_08_BMC_And_CPU_Internal_USB_Network_Stress_Test  common  test8   minipack3
    Log Info  ===== Start of META_STRESS_COM_TCG1_08_BMC_And_CPU_Internal_USB_Network_Stress_Test =====
    Set Testcase Timeout  ${Timeout10000}
    #Set Global Variable     ${StressLoopTime900}    60
    set bmc cpu link stress loop time  2
    switch to centos diag tool
...
META_STRESS_COM_TCG1_09_Sensor_Reading_Stress-Idle
    ...
    [Tags]  META_STRESS_COM_TCG1_09_Sensor_Reading_Stress-Idle  
    ...
    FOR    ${INDEX}    IN RANGE    1    21
        Print Loop Info  ${INDEX}   ${MaxRepeatCount5}
        run sensor option u and verify GB run test     #for wedge
        minipack3 run sensor reading idle stress test    #for mp2
    END
...
META_STRESS_COM_TCG1_10_COMe_Memory_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG1_10_COMe_Memory_Stress_Test  common  minipack3  test10 
...
META_STRESS_COM_TCG1_11_COMe_CPU_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG1_11_COMe_CPU_Stress_Test  common  test11  minipack3
    FOR    ${INDEX}    IN RANGE    1    2
       #switch to centos diag tool 
        minipack3 check system cpu stress  DUT
        exit unidiag interface  DUT
    END
...
META_STRESS_COM_TCG1_12_OpenBMC_Memory_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG1_12_OpenBMC_Memory_Stress_Test  common  test12  minipack3
    Log Info  ===== Start of META_STRESS_COM_TCG1_12_OpenBMC_Memory_Stress_Test =====
    [Setup]  prepare MEM_TEST images    
    set openbmc memory stress loop time  ${StressLoopTime120}
    set openbmc memory test cycles  5
    #switch to openbmc check tool
    run openbmc memory stress test  10M 2
...
META_STRESS_COM_TCG1_13_OpenBMC_I2C_Bus_Scan_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG1_13_OpenBMC_I2C_Bus_Scan_Stress_Test  test13  minipack3
    [Setup]  switch to centos
    Log Info  ===== Start of META_STRESS_COM_TCG1_13_OpenBMC_I2C_Bus_Scan_Stress_Test =====
    Set Testcase Timeout  ${Timeout10000}
    Set Global Variable     ${StressLoopTime1800}    60
    set i2c scan stress loop time  1000
    check_unidiag_system_versions  DUT
    check_system_i2c_scan   DUT
    exit unidiag interface  DUT
    [Teardown]  Run Keyword If Test Failed  exit unidiag interface  DUT
...
META_STRESS_COM_TCG1_14_TPM_Module_Access_Stress_test
    ...
    [Tags]  META_STRESS_COM_TCG1_14_TPM_Module_Access_Stress_test  test14  minipack3
    [Setup]  switch to centos
    Log Info  ===== Start of META_STRESS_COM_TCG1_14_TPM_Module_Access_Stress_test =====
    Set Testcase Timeout  ${Timeout4500}
    Set Global Variable     ${MaxRepeatCount20}    
    FOR    ${INDEX}    IN RANGE    1   ${MaxRepeatCount5}
       Step  1  minipack3 run tpm test  DUT 
       Step  2  exit unidiag interface  DUT
    END
    switch to centos
...
META_STRESS_COM_TCG1_15_Each_Port_Enable_Disable_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG1_15_Each_Port_Enable_Disable_Stress_Test   minipack3  test15
    ...
    END
    Step  2  check_l2_cpu_traffic  DUT  ${load_128x400}
...
META_STRESS_COM_TCG1_16_SDK_Re-Init_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG1_16_SDK_Re-Init_Stress_Test    minipack3   test16
...
META_STRESS_COM_TCG1_17_Snake_Traffic_Test
    ...
    [Tags]  META_STRESS_COM_TCG1_17_Snake_Traffic_Test   minipack3  test17
...
META_STRESS_COM_TCG2_02_Chassis_Power_Cycling_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG2_02_Chassis_Power_Cycling_Stress_Test  meta_stress  wedge400c  wedge400  minipack31
...
META_STRESS_COM_TCG2_03_COMe_Warm_Reset_from_High_Loading_Test
    ...
    [Tags]  META_STRESS_COM_TCG2_03_COMe_Warm_Reset_from_High_Loading_Test  meta_stress  wedge400c  wedge400  minipack31
...
META_STRESS_COM_TCG2_04_COMe_Power_On_And_Off_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG2_04_COMe_Power_On_And_Off_Stress_Test  meta_stress  wedge400c  wedge400  minipack31
...
META_STRESS_COM_TCG2_05_COMe_Hard_Reset_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG2_05_COMe_Hard_Reset_Stress_Test  meta_stress  wedge400c  wedge400  minipack31
...
META_STRESS_COM_TCG2_06_Primary_BIOS_Update_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG2_06_Primary_BIOS_Update_Stress_Test  meta_stress  wedge400c  wedge400  minipack31  critical
...
META_STRESS_COM_TCG2_07_CPLD_Online_Update_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG2_07_CPLD_Online_Update_Stress_Test  meta_stress  wedge400c  wedge400  minipack31  critical
...
META_STRESS_COM_TCG2_08_FPGA_Online_Update_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG2_08_FPGA_Online_Update_Stress_Test  meta_stress  wedge400c  wedge400  minipack31  critical
...
META_STRESS_COM_TCG2_09_Full_Loading_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG2_09_Full_Loading_Stress_Test  meta_stress  wedge400c  wedge400  minipack31
...
META_STRESS_COM_TCG2_11_System_Idle_Or_Working_State_Swap_Test
    ...
    [Tags]  META_STRESS_COM_TCG2_11_System_Idle_Or_Working_State_Swap_Test  meta_stress  wedge400c  wedge400  minipack31
...
META_STRESS_COM_TCG2_12_System_Idle_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG2_12_System_Idle_Stress_Test  meta_stress  wedge400c  wedge400  minipack31
...
META_STRESS_COM_TCG2_13_BIC_Update_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG2_13_BIC_Update_Stress_Test  meta_stress  wedge400c  wedge400  minipack31  critical
...
META_STRESS_COM_TCG2_14_COMe_Warm_Reset_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG2_14_COMe_Warm_Reset_Stress_Test  meta_stress  wedge400c  wedge400  minipack31
...
META_STRESS_COM_TCG2_15_Master_BMC_Online_Update_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG2_15_Master_BMC_Online_Update_Stress_Test  meta_stress  wedge400c  wedge400  minipack31  critical
...
META_STRESS_COM_TCG2_16_OpenBMC_Swap_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG2_16_OpenBMC_Swap_Stress_Test  meta_stress  wedge400c  wedge400  minipack31
...
META_STRESS_COM_TCG2_19_Reset_Port_Link_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG2_19_Reset_Port_Link_Stress_Test  meta_stress  wedge400  minipack31
...
META_STRESS_COM_TCG2_23_Sol_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG2_23_Sol_Stress_Test  meta_stress  wedge400c  wedge400  minipack31
...
META_STRESS_COM_TCG2_SPEC_03_All_Ports_Enable_Disable_Link_Stress_Test
    ...
    [Tags]  META_STRESS_COM_TCG2_SPEC_03_All_Ports_Enable_Disable_Link_Stress_Test  meta_stress  wedge400  minipack31
    ...
    Step  3  minipack3 run port enable disable test  True
