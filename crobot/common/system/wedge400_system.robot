...
# Date         : June 09, 2020                                                                                        #
# Author       : TK                                                                                                   #
# Description  : This script will run all system stress tests.                                                        #
#                                                                                                                     #
...
FB_SYS_COM_TCG1-01_Sensor_Reading_Stress-High_Loading
    ...
    [Tags]  FB_SYS_COM_TCG1-01_Sensor_Reading_Stress-High_Loading  depend_sdk  wedge400
    ...
    w400 run sensor reading high loading stress test
    Log Info  ===== Start of testCase FB_SYS_COM_TCG1-01_Sensor_Reading_Stress-High_Loading =====


FB_SYS_COM_TCG1-02_FPGA_PCIE_Bus_Stress_Test
    [Documentation]  Synopsis=> This test checks the function of FPGA PCIE bus.
    [Tags]  FB_SYS_COM_TCG1-02_FPGA_PCIE_Bus_Stress_Test  common  wedge400
...
FB_SYS_COM_TCG1-03_OpenBMC_Utility_Stability_Test
    ...
    [Tags]  FB_SYS_COM_TCG1-03_OpenBMC_Utility_Stability_Test  wedge400
...
FB_SYS_COM_TCG1-04_IPMI_Interface_Stress_Test
    ...
    [Tags]  FB_SYS_COM_TCG1-04_IPMI_Interface_Stress_Test  wedge400
    ...
    switch to centos diag tool
    wedge400c run ipmi command stress test
...
FB_SYS_COM_TCG1-05_COMe_NVMe_SSD_RW_Stress_Test
    ...
    [Tags]  FB_SYS_COM_TCG1-05_COMe_NVMe_SSD_RW_Stress_Test  common  wedge400
...
FB_SYS_COM_TCG1-06_Loopback_EEPROM_Access_Stress_Test
    ...
    [Tags]  FB_SYS_COM_TCG1-06_Loopback_EEPROM_Access_Stress_Test  depend_sdk  wedge400
    ...
    switch to centos diag tool
    wedge400c run eeprom access stress test
...
FB_SYS_COM_TCG1-07_BMC_And_CPU_OOB_Link_Stress_Test
    ...
    [Tags]  FB_SYS_COM_TCG1-07_BMC_And_CPU_OOB_Link_Stress_Test  common  wedge400
...
FB_SYS_COM_TCG1-08_BMC_And_CPU_Internal_USB_Network_Stress_Test
    ...
    [Tags]  FB_SYS_COM_TCG1-08_BMC_And_CPU_Internal_USB_Network_Stress_Test  common  wedge400
...
FB_SYS_COM_TCG1-09_Sensor_Reading_Stress-Idle
    ...
    [Tags]  FB_SYS_COM_TCG1-09_Sensor_Reading_Stress-Idle  depend_sdk  wedge400
    ...
    set auto load script stress loop time  ${StressLoopTime1800}
    #switch to centos
    run sensor option u and verify GB run test
    #switch to centos
    run sensor option u and verify GB run test
    #exit sdk mode
    Log Info  ===== Start of testCase FB_SYS_COM_TCG1-09_Sensor_Reading_Stress-Idle =====
...
FB_SYS_COM_TCG1-10_COMe_Memory_Stress_Test
    ...
    [Tags]  FB_SYS_COM_TCG1-10_COMe_Memory_Stress_Test  common   wedge400
...
FB_SYS_COM_TCG1-11_COMe_CPU_Stress_Test
    ...
    [Tags]  FB_SYS_COM_TCG1-11_COMe_CPU_Stress_Test  common  wedge400
...
FB_SYS_COM_TCG1-12_OpenBMC_Memory_Stress_Test
    ...
    [Tags]  FB_SYS_COM_TCG1-12_OpenBMC_Memory_Stress_Test  common  wedge400
...
FB_SYS_COM_TCG1-13_OpenBMC_I2C_Bus_Scan_Stress_Test
    ...
    [Tags]  FB_SYS_COM_TCG1-13_OpenBMC_I2C_Bus_Scan_Stress_Test  wedge400
    Log Info  ===== Start of FB_SYS_COM_TCG1-13_OpenBMC_I2C_Bus_Scan_Stress_Test =====
    Set Testcase Timeout  ${Timeout3600}
    #Set Global Variable     ${StressLoopTime1800}    60
    set i2c scan stress loop time  ${StressLoopTime1800}
    switch to openbmc check tool
    w400 mp copy i2c config files
    wedge400 run openbmc i2c scan stress test
...
FB_SYS_COM_TCG1-14_TPM_Module_Access_Stress_test
    ...
    [Tags]  FB_SYS_COM_TCG1-14_TPM_Module_Access_Stress_test  wedge400
...
FB_SYS_COM_TCG1-15_Each_Port_Enable_Disable_Stress_Test
    ...
    [Tags]  FB_SYS_COM_TCG1-15_Each_Port_Enable_Disable_Stress_Test  depend_sdk  wedge400
...
FB_SYS_COM_TCG1-16_SDK_Re-Init_Stress_Test
    ...
    [Tags]  FB_SYS_COM_TCG1-16_SDK_Re-Init_Stress_Test  depend_sdk  wedge400
...
FB_SYS_COM_TCG1-17_Snake_Traffic_Test
    ...
    [Tags]  FB_SYS_COM_TCG1-17_Snake_Traffic_Test  depend_sdk  wedge400
