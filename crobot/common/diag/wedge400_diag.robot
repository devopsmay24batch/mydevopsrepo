...
FB_DIAG_COMM_TC_000_DIAG_INSTALL_UNINSTALL
    ...
    [Tags]  FB_DIAG_COMM_TC_000_DIAG_INSTALL_UNINSTALL  common  wedge400  critical
	...
	Step  3  clean diag rpm
        ...
        #Step  10  w400 mp copy i2c config files
    END
...
FB_DIAG_W400C_TC_002_PEM_TEST
     ...
     [Tags]  FB_DIAG_W400C_TC_002_PEM_TEST  wedge400
...
FB_DIAG_COMM_TC_001_MANAGEMENT_ETHER_PORT_MAC_CHECK_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_001_MANAGEMENT_ETHER_PORT_MAC_CHECK_TEST  common  wedge400
...
FB_DIAG_COMM_TC_002_CPU_Information_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_002_CPU_Information_TEST  common  wedge400  critical
...
FB_DIAG_COMM_TC_003_FPGA_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_003_FPGA_TEST  common  wedge400
...
FB_DIAG_COMM_TC_004_DIMM_SPD_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_004_DIMM_SPD_TEST  common  wedge400
...
FB_DIAG_COMM_TC_005_USB_STORAGE_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_005_USB_Storage_TEST  common  wedge400
...
FB_DIAG_COMM_TC_006_RTC_Test
    ...
    [Tags]  FB_DIAG_COMM_TC_006_RTC_Test  common  wedge400
...
#     [Tags]  FB_DIAG_COMM_TC_007_PCIE_DEVICES_TEST  common  wedge400
...
FB_DIAG_COMM_TC_008_FW_SW_INFO_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_008_FW_SW_INFO_TEST  common  wedge400
...
#    [Tags]  FB_DIAG_COMM_TC_009_PORT_LED_TEST  common  wedge400
...
FB_DIAG_COMM_TC_010_TPM_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_010_TPM_TEST  common  wedge400
...
FB_DIAG_COMM_TC_011_BIC_Test
    ...
    [Tags]  FB_DIAG_COMM_TC_011_BIC_Test  common  wedge400
...
FB_DIAG_COMM_TC_012_NVME_SSD_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_012_NVME_SSD_TEST  common  wedge400
...
#     [Tags]  FB_DIAG_COMM_TC_013_OOB_TEST  common  wedge400
...
FB_DIAG_COMM_TC_014_QSFP_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_014_QSFP_TEST  common  wedge400
...
FB_DIAG_COMM_TC_015_CPLD_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_015_CPLD_TEST  common  wedge400
...
FB_DIAG_COMM_TC_016_E_Loopback_High_power_mode
    ...
    [Tags]  FB_DIAG_COMM_TC_016_E_Loopback_High_power_mode  common  wedge400
...
FB_DIAG_COMM_TC_017_RJ45_MANAGEMENT_PORT_CONNECT_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_017_RJ45_MANAGEMENT_PORT_CONNECT_TEST  common  wedge400
...
FB_DIAG_COMM_TC_018_CPU_STRESS_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_018_CPU_STRESS_TEST  common  wedge400
...
#    [Tags]  FB_DIAG_COMM_TC_019_CPU_POWER_STRESS_TEST  common  wedge400
...
FB_DIAG_COMM_TC_020_DDR_STRESS_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_020_DDR_STRESS_TEST  common  wedge400
...
FB_DIAG_COMM_TC_021_SSD_STRESS_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_021_SSD_STRESS_TEST  common  wedge400
...
FB_DIAG_COMM_TC_022_PCIE_STRESS_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_022_PCIE_STRESS_TEST  common  wedge400
...
#    [Tags]  FB_DIAG_COMM_TC_023_LPMODE_STRESS_TEST  common  wedge400
...
FB_DIAG_COMM_TC_024_SYSTEM_LOG_CHECK_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_024_System_log_check_Test  common  wedge400
...
FB_DIAG_COMM_TC_033_FRU_EEPROM_UPDATE
    ...
    [Tags]  FB_DIAG_COMM_TC_033_FRU_EEPROM_UPDATE  common  wedge400
...
#    [Tags]  FB_DIAG_COMM_TC_035_BCM5389_EEPROM_UPDATE  common  wedge400
...
FB_DIAG_COMM_TC_036_BMC_BIOS_BOOT_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_036_BMC_BIOS_BOOT_TEST  common  wedge400
...
FB_DIAG_COMM_TC_037_BMC_CPU_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_037_BMC_CPU_TEST  common  wedge400
...
FB_DIAG_COMM_TC_038_BMC_FPGA_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_038_BMC_FPGA_TEST  common  wedge400
...
FB_DIAG_COMM_TC_039_BMC_CPLD_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_039_BMC_CPLD_TEST  common  wedge400
...
FB_DIAG_COMM_TC_040_I2C_DEVICE_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_040_I2C_DEVICE_TEST  common  wedge400
...
FB_DIAG_COMM_TC_041_FAN_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_041_FAN_TEST  common  wedge400
...
FB_DIAG_COMM_TC_042_MEMORY_TEST
    [Documentation]  Synopsis=> This test executes to test the fan.
    [Tags]  FB_DIAG_COMM_TC_042_MEMORY_TEST  common  wedge400
...
FB_DIAG_COMM_TC_043_EMMC_TEST
    [Documentation]  Synopsis=> This test executes to test the fan.
    [Tags]  FB_DIAG_COMM_TC_043_EMMC_TEST  common  wedge400
...
#    [Tags]  FB_DIAG_COMM_TC_045_MDIO_TEST  common  wedge400
...
FB_DIAG_COMM_TC_044_INTERNAL_UART_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_044_INTERNAL_UART_TEST  common  wedge400
...
FB_DIAG_COMM_TC_046_HOT_SWAP_CONTROLLER_ACCESS_TEST
    [Documentation]  Synopsis=> This test executes to test the SCM and FCM hot_swap function.
    [Tags]  FB_DIAG_COMM_TC_046_HOT_SWAP_CONTROLLER_ACCESS_TEST  common  wedge400
...
FB_DIAG_COMM_TC_047_TPM_DEVICE_ACCESS_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_047_TPM_DEVICE_ACCESS_TEST  common  wedge400
...
FB_DIAG_COMM_TC_049_PSU_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_049_PSU_TEST  common  wedge400
...
FB_DIAG_COMM_TC_050_SENSOR_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_050_SENSOR_TEST  common  wedge400
...
FB_DIAG_COMM_TC_051_RJ45_MANAGEMENT_PORT_CONNECT_TEST
    [Documentation]  Synopsis=> This test executes to check RJ45 for Management eth port. Ping remote PC from DUT.
    [Tags]  FB_DIAG_COMM_TC_051_RJ45_MANAGEMENT_Port_CONNECT_TEST  common  wedge400
...
#FB_DIAG_COMM_TC_052_OCP_DEBUG_CARD
    ...
    #[Tags]  FB_DIAG_COMM_TC_052_OCP_DEBUG_CARD  common  wedge400
...
FB_DIAG_COMM_TC_053_FIRMWARE_SOFTWARE_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_053_FIRMWARE_SOFTWARE_TEST  common  wedge400
...
FB_DIAG_COMM_TC_054_PLATFORM_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_054_PLATFORM_TEST  common  wedge400
...
#    [Tags]  FB_DIAG_COMM_TC_055_TEST_ALL  common  wedge400
...
FB_DIAG_COMM_TC_056_DDR_AND_EMMC_STRESS_TEST
    ...
    [Tags]  eric56  FB_DIAG_COMM_TC_056_DDR_AND_EMMC_STRESS_TEST  common  wedge400
...
#     [Tags]  FB_DIAG_COMM_TC_057_FPGA_UPGRADE_STRESS_TEST  common  wedge400
...
FB_DIAG_COMM_TC_058_BIOS_CONFIG_CHECK_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_058_BIOS_CONFIG_CHECK_TEST  common  wedge400
    [Setup]  Set terminal auto-logout timeout  console=${centos_mode}
...
FB_DIAG_COMM_TC_057_SYSTEM_LOG_CHECK_TEST
    ...
    [Tags]  FB_DIAG_COMM_TC_057_SYSTEM_LOG_CHECK_TEST  common  wedge400
