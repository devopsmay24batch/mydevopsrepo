...
*** Settings ***
Documentation       Tests to verify OpenBMC functions described in the OpenBMC function SPEC for the project Cloudripper.
...
FB_BMC_COMM_TC_003_Online_Update_BMC_in_BMC_OS
    ...
    [Tags]     common  FB_BMC_COMM_TC_003_Online_Update_BMC_in_BMC_OS  cloudripper  critical
...
FB_BMC_COMM_TC_004_OpenBMC_Uart_Information_Check
    ...
    [Tags]     common  FB_BMC_COMM_TC_004_OpenBMC_Uart_Information_Check  cloudripper
...
FB_BMC_COMM_TC_005_Online_Update_BIOS_in_BMC_OS
    ...
    [Tags]     common  FB_BMC_COMM_TC_005_Online_Update_BIOS_in_BMC_OS  cloudripper  critical
    [Timeout]  150 min 00 seconds
...
### temporary disable because it still has a certain ratio of fail.
# uncomment it because of support it --Jeff Gong 03/23/2021
FB_BMC_COMM_TC_006_Online_update_CPLD_in_BMC_OS
    ...
    [Tags]     common  FB_BMC_COMM_TC_006_Online_update_CPLD_in_BMC_OS  cloudripper  critical
    [Timeout]  50 min 00 seconds
    [Setup]    prepare images  CPLD
    Sub-Case  FB_BMC_COM_TC_006_1  CPLD upgrade and check CPLD version cloudripper
...
FB_BMC_COMM_TC_007_Online_Update_BIC_Bridge_in_BMC_OS
    ...
    [Tags]     common  FB_BMC_COMM_TC_007_Online_Update_BIC_Bridge_in_BMC_OS  cloudripper  critical
...
# checkout so far do not support
#FB_BMC_COMM_TC_008_BIC_Frequency_Auto_Set_Test
 #   [Documentation]  This test checks BIC Frequency auto set successfully in OpenBMC OS
  #  [Tags]     common  FB_BMC_COMM_TC_008_BIC_Frequency_Auto_Set_Test  cloudripper
   # [Timeout]  40 min 00 seconds
...
FB_BMC_COMM_TC_009_Online_Update_FPGA_In_BMC_OS
    ...
    [Tags]     common  FB_BMC_COMM_TC_009_Online_Update_FPGA_In_BMC_OS  cloudripper  critical
    [Timeout]  70 min 00 seconds
    [Setup]    prepare images  FPGA
    Sub-Case  FB_BMC_COMM_TC_009_1  FPGA upgrade and check FPGA version cloudripper
    [Teardown]  clean images  DUT  FPGA

### temporary disable because it supports only EVT3.
# uncomment it because of support it --Jeff Gong 03/23/2021
# becasuse of cloudripper output is 0000000000000, not expected output so comment it again   --Jeff 03/24
FB_BMC_COMM_TC_010_Online_Update_OOB_Switch_FW_in_BMC_OS
    ...
    [Tags]     common  FB_BMC_COMM_TC_010_Online_Update_OOB_Switch_FW_in_BMC_OS  cloudripper  critical
...
FB_BMC_COMM_TC_011_Backup_BMC_Manual_Booting_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_011_Backup_BMC_Manual_Booting_Test  cloudripper
...
FB_BMC_COMM_TC_013_Backup_BIOS_Manual_Booting_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_013_Backup_BIOS_Manual_Booting_Test  cloudripper
    ...
    [Teardown]  switch bios flash to Master
...
FB_BMC_COMM_TC_014_BMC_Network_Config_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_014_BMC_Network_Config_Test  cloudripper
...
FB_BMC_COMM_TC_018_Internal_USB_Network_Check
    ...
    [Tags]     common  FB_BMC_COMM_TC_018_Internal_USB_Network_Check  cloudripper
...
FB_BMC_COMM_TC_019_OpenBMC_MAC_Address_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_019_OpenBMC_MAC_Address_Test  cloudripper
    [Timeout]  50 min 00 seconds
...
FB_BMC_COMM_TC_020_Power_Control
    ...
    [Tags]     common  FB_BMC_COMM_TC_020_Power_Control  cloudripper
    [Timeout]  40 min 00 seconds
...
FB_BMC_COMM_TC_021_OpenBMC_Reset_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_021_OpenBMC_Reset_Test  cloudripper
...
FB_BMC_COMM_TC_022_Sensor_Info_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_022_Sensor_Info_Test  cloudripper
...
# checkout so far do not support
# only support set fscd, not support start or stop fscd, ps|grep fscd --Jeff 03/24
FB_BMC_COMM_TC_023_Fan_Speed_Manual_Control
    [Documentation]  This test verifies BMC can control the fan speed manually
    [Tags]     common  FB_BMC_COMM_TC_023_Fan_Speed_Manual_Control  cloudripper
    [Timeout]  10 min 00 seconds
    [Setup]  set time delay  60
    # release it because now CR support it  -Jeff
    ...
    Sub-Case  FB_BMC_COMM_TC_023_2  set and get fan speed 10
    Sub-Case  FB_BMC_COMM_TC_023_3  set and get fan speed 25
...
## checkout so far do not support
## release it because now CR support it --Jeff 2021/05/06
## comment it because of auto checkout slave mode
#FB_BMC_COMM_TC_033_WD1_Test
 #   [Documentation]  This test verifies when WD1 be activated, system will auto reboot when stop feeding
  #  [Tags]     common  FB_BMC_COMM_TC_033_WD1_Test  cloudripper
   # [Timeout]  40 min 00 seconds
...
FB_BMC_COMM_TC_034_SCM_EEPROM_R/W_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_034_SCM_EEPROM_R/W_Test  cloudripper
    [Timeout]  25 min 00 seconds
...
FB_BMC_COMM_TC_035_SMB_EEPROM_R/W_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_035_SMB_EEPROM_R/W_Test  cloudripper
    [Timeout]  25 min 00 seconds
...
FB_BMC_COMM_TC_036_FCB_EEPROM_R/W_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_036_FCB_EEPROM_R/W_Test  cloudripper
    [Timeout]  45 min 00 seconds
...
FB_BMC_COMM_TC_037_FAN_EEPROM_R/W_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_037_FAN_EEPROM_R/W_Test  cloudripper
    [Timeout]  45 min 00 seconds
...
FB_BMC_COMM_TC_038_AC_PSU_EEPROM_Access_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_038_AC_PSU_EEPROM_Access_Test  cloudripper
    [Timeout]  10 min 00 seconds
...
FB_BMC_COMM_TC_039_eMMC_R/W_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_039_eMMC_R/W_Test  cloudripper
    [Timeout]  40 min 00 seconds
...
FB_BMC_COMM_TC_040_Restful_fruid_test
    ...
    [Tags]     common  FB_BMC_COMM_TC_040_Restful_fruid_test  cloudripper
    [Timeout]  10 min 00 seconds
...
FB_BMC_COMM_TC_041_Restful_BMC_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_041_Restful_BMC_Test  cloudripper
    [Timeout]  5 min 00 seconds
    [Setup]  set time delay  90
...
FB_BMC_COMM_TC_042_Restful_Sensors_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_042_Restful_Sensors_Test  cloudripper
    [Timeout]  10 min 00 seconds
    [Setup]  set time delay  90
...
FB_BMC_COMM_TC_043_Restful_Status_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_043_Restful_Status_Test  cloudripper
    [Timeout]  10 min 00 seconds
    [Setup]  set time delay  90
...
FB_BMC_COMM_TC_045_weutil_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_045_weutil_Test  cloudripper
    [Timeout]  10 min 00 seconds
...
FB_BMC_COMM_TC_046_feutil_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_046_feutil_Test  cloudripper
    [Timeout]  10 min 00 seconds
...
FB_BMC_COMM_TC_047_seutil_Test
    [Documentation]  This test verifies the utility could be executed successfully
    [Tags]     common  FB_BMC_COMM_TC_047_seutil_Test  cloudripper
    [Timeout]  10 min 00 seconds
...
FB_BMC_COMM_TC_048_BIC_Utility_Test
    [Documentation]  This test verifies the utility could be executed successfully with all support parameters
    [Tags]     common  FB_BMC_COMM_TC_048_BIC_Utility_Test  cloudripper
    [Timeout]  15 min 00 seconds
...
FB_BMC_COMM_TC_049_SPI_Utility_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_049_SPI_Utility_Test  cloudripper
...
FB_BMC_COMM_TC_050_Version_Utility_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_050_Version_Utility_Test  cloudripper
    [Timeout]  5 min 00 seconds
...
FB_BMC_COMM_TC_051_Presence_Utility_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_051_Presence_Utility_Test  cloudripper
...
FB_BMC_COMM_TC_053_Sensor_Utility_Test
    [Documentation]  This test verifies the utility could be executed successfully with all support parameters
    [Tags]     common  FB_BMC_COMM_TC_053_Sensor_Utility_Test  cloudripper
    [Timeout]  60 min 00 seconds
...
FB_BMC_COMM_TC_054_PSU_Utility_Test_AC_PSU
    [Documentation]  This test verifies the utility could be executed successfully with all support parameters
    [Tags]     common  FB_BMC_COMM_TC_054_PSU_Utility_Test_AC_PSU  cloudripper
    [Timeout]  5 min 00 seconds
    Sub-Case  FB_BMC_COMM_TC_054_1  run all the parameters of psu-util cloudripper
...
FB_BMC_COMM_TC_055_Tftp_Client_Tool_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_055_Tftp_Client_Tool_Test  cloudripper
    [Timeout]  5 min 00 seconds
...
FB_BMC_COMM_TC_056_Get_Device_ID
    ...
    [Tags]     common  FB_BMC_COMM_TC_056_Get_Device_ID  cloudripper
    [Timeout]  40 min 00 seconds
...
FB_BMC_COMM_TC_057_Reset_BMC_From_Host
    ...
    [Tags]     common  FB_BMC_COMM_TC_057_Reset_BMC_From_Host  cloudripper
    [Timeout]  10 min 00 seconds
...
FB_BMC_COMM_TC_058_Get_Selftest_Results
    ...
    [Tags]     common  FB_BMC_COMM_TC_058_Get_Selftest_Results  cloudripper
    [Timeout]  30 min 00 seconds
...
FB_BMC_COMM_TC_059_Get_Device_GUID
    ...
    [Tags]     common  FB_BMC_COMM_TC_059_Get_Device_GUID  cloudripper
    [Timeout]  2 min 00 seconds
...
FB_BMC_COMM_TC_064_System_Info_Parameters_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_064_System_Info_Parameters_Test  cloudripper
    [Timeout]  15 min 00 seconds
...
FB_BMC_COMM_TC_066_Get_Lan_Configuration
    ...
    [Tags]     common  FB_BMC_COMM_TC_066_Get_Lan_Configuration  cloudripper
    [Timeout]  2 min 00 seconds
...
FB_BMC_COMM_TC_067_Get_SOL_Configuration
    ...
    [Tags]     common  FB_BMC_COMM_TC_067_Get_SOL_Configuration  cloudripper
    [Timeout]  2 min 00 seconds
...
FB_BMC_COMM_TC_070_Get_Board_ID
    ...
    [Tags]     common  FB_BMC_COMM_TC_070_Get_Board_ID  cloudripper
    [Timeout]  2 min 00 seconds
...
FB_BMC_COMM_TC_071_Get_Port80_Record
    ...
    [Tags]     common  FB_BMC_COMM_TC_071_Get_Port80_Record  cloudripper
    [Timeout]  2 min 00 seconds
...
FB_BMC_COMM_TC_072_Get_PCIE_Configuration
    ...
    [Tags]     common  FB_BMC_COMM_TC_072_Get_PCIE_Configuration  cloudripper
    [Timeout]  2 min 00 seconds
...
FB_BMC_COMM_TC_073_Set_POST_Start
    ...
    [Tags]     common  FB_BMC_COMM_TC_073_Set_POST_Start  cloudripper
    [Timeout]  2 min 00 seconds
    Sub-Case  FB_BMC_COMM_TC_073_1  issue "set post start" command

FB_BMC_COMM_TC_074_Set_POST_End
    [Documentation]  This test verifies the OEM command can be executed successfully
    [Tags]     common  FB_BMC_COMM_TC_074_Set_POST_End  cloudripper
    [Timeout]  2 min 00 seconds
...
FB_BMC_COMM_TC_076_DIMM_Information_Get/Set_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_076_DIMM_Information_Get/Set_Test  cloudripper
    [Timeout]  20 min 00 seconds
    [Setup]  go to centos
...
FB_BMC_COMM_TC_077_Processor_Information_Get/Set_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_077_Processor_Information_Get/Set_Test  cloudripper
    [Timeout]  15 min 00 seconds
    [Setup]  go to centos
...
FB_BMC_COMM_TC_084_OpenBMC_Memory_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_084_OpenBMC_Memory_Test  cloudripper
    [Timeout]  30 min 00 seconds
...
FB_BMC_COMM_TC_085_SOL_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_085_SOL_Test  cloudripper
    [Timeout]  10 min 00 seconds
    [Setup]    go to openbmc
...
FB_BMC_COMM_TC_086_CPLD_Register_R/W_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_086_CPLD_Register_R/W_Test  cloudripper
    [Timeout]  15 min 00 seconds
...
FB_BMC_COMM_TC_087_TPM_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_087_TPM_Test  cloudripper
    [Timeout]  150 min 00 seconds
...
FB_BMC_COMM_TC_089_MDIO_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_089_MDIO_Test  cloudripper
    [Timeout]  4 min 00 seconds
    Sub-Case  FB_BMC_COMM_TC_089_1  run command to read mdio reg cloudripper
    Sub-Case  FB_BMC_COMM_TC_089_2  run command to write and read mdio reg cloudripper
    Sub-Case  FB_BMC_COMM_TC_089_3  run command to write and read mdio reg again cloudripper
    [Teardown]  run command to write mdio to default value cloudripper

FB_BMC_COMM_TC_090_CIT_Test
    [Documentation]  This test verifies CIT Test
    [Tags]     common  FB_BMC_COMM_TC_090_CIT_Test  cloudripper
    [Timeout]  60 min 00 seconds
