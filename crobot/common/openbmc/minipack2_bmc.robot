...
*** Settings ***
Documentation       Tests to verify OpenBMC functions described in the OpenBMC function SPEC for the project Minipack2.
...
BMC_COMM_TC_000_Online_Update_slave_BMC_and_diag
    ...
    [Tags]     common  BMC_COMM_TC_000_Online_Update_slave_BMC_and_diag  minipack2  critical
...
FB_BMC_COMM_TC_003_Online_Update_BMC_in_BMC_OS
    [Documentation]  This test checks the BMC FW programming functions by updating the BMC FW in BMC OS
    [Tags]     common  FB_BMC_COMM_TC_003_Online_Update_BMC_in_BMC_OS  minipack2  critical
...
FB_BMC_COMM_TC_004_OpenBMC_Uart_Information_Check
    ...
    [Tags]     common  FB_BMC_COMM_TC_004_OpenBMC_Uart_Information_Check  minipack2  
...
FB_BMC_COMM_TC_005_Online_Update_BIOS_in_BMC_OS
    ...
    [Tags]     common  FB_BMC_COMM_TC_005_Online_Update_BIOS_in_BMC_OS  minipack2  critical
    [Timeout]  150 min 00 seconds
...
# release it because of support it now --Jeff Gong 3/30
FB_BMC_COMM_TC_006_Online_update_CPLD_in_BMC_OS
    ...
    [Tags]     common  FB_BMC_COMM_TC_006_Online_update_CPLD_in_BMC_OS  minipack2  critical
    [Timeout]  150 min 00 seconds
    [Setup]    prepare images  CPLD
    Sub-Case  FB_BMC_COM_TC_006_1  CPLD upgrade and check CPLD version minipack2
    Sub-Case  FB_BMC_COM_TC_006_2  CPLD downgrade and check CPLD version minipack2
    Sub-Case  FB_BMC_COM_TC_006_1  CPLD upgrade and check CPLD version minipack2
    [Teardown]  clean images  DUT  CPLD
# cancel this case temply for the HW issue
# suppost run this cases --Jeff 03/18/2021
FB_BMC_COMM_TC_007_Online_Update_BIC_Bridge_in_BMC_OS
    ...
    [Tags]     common  FB_BMC_COMM_TC_007_Online_Update_BIC_Bridge_in_BMC_OS  minipack2  critical
...
#    [Tags]     common  FB_BMC_COMM_TC_008_BIC_Frequency_Auto_Set_Test  minipack2  
#    [Timeout]  40 min 00 seconds
...
FB_BMC_COMM_TC_009_Online_Update_FPGA_In_BMC_OS
   ...
   [Tags]     common  FB_BMC_COMM_TC_009_Online_Update_FPGA_In_BMC_OS  minipack2  critical
   [Timeout]  70 min 00 seconds
   [Setup]    prepare images  FPGA
   Sub-Case  FB_BMC_COMM_TC_009_1  FPGA upgrade and check FPGA version minipack2
   Sub-Case  FB_BMC_COMM_TC_009_2  FPGA downgrade and check FPGA version minipack2
   Sub-Case  FB_BMC_COMM_TC_009_3  FPGA upgrade and check FPGA version minipack2
...
#    [Tags]     common  FB_BMC_COMM_TC_010_Online_Update_OOB_Switch_FW_in_BMC_OS  minipack2
...
#    [Teardown]  clean up file  DUT  dump1 dump2 dump3

FB_BMC_COMM_TC_011_Backup_BMC_Manual_Booting_Test
    [Documentation]  This test checks BMC can boot from slave by command
    [Tags]     common  FB_BMC_COMM_TC_011_Backup_BMC_Manual_Booting_Test  minipack2  
...
FB_BMC_COMM_TC_014_BMC_Network_Config_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_014_BMC_Network_Config_Test  minipack2  
    [Timeout]  10 min 00 seconds
    [Setup]  go to openbmc
    Sub-Case  FB_BMC_COMM_TC_014_1  reboot and check dhcp setting info and check ipv6 address mp2
...
FB_BMC_COMM_TC_016_IPv6_Ping_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_016_IPv6_Ping_Test  minipack2
    [Timeout]  10 min 00 seconds
...
FB_BMC_COMM_TC_017_IPv6_SSH_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_017_IPv6_SSH_Test  minipack2
    [Timeout]  10 min 00 seconds
...
FB_BMC_COMM_TC_018_Internal_USB_Network_Check
    ...
    [Tags]     common  FB_BMC_COMM_TC_018_Internal_USB_Network_Check  minipack2  
    [Timeout]  5 min 00 seconds
    [Setup]  ssh login bmc  DUT
    ...
    [Teardown]    clean up file on both bmc and cpu and ssh disconnect

FB_BMC_COMM_TC_019_OpenBMC_MAC_Address_Test
    [Documentation]  This test checks the BMC MAC address
    [Tags]     common  FB_BMC_COMM_TC_019_OpenBMC_MAC_Address_Test  minipack2
...
FB_BMC_COMM_TC_020_Power_Control
    ...
    [Tags]     common  FB_BMC_COMM_TC_020_Power_Control  minipack2  
    [Timeout]  40 min 00 seconds
...
FB_BMC_COMM_TC_021_OpenBMC_Reset_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_021_OpenBMC_Reset_Test  minipack2  
...
FB_BMC_COMM_TC_022_Sensor_Info_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_022_Sensor_Info_Test  minipack2
    [Timeout]  30 min 00 seconds
    [Setup]  set time delay  60
    Sub-Case  FB_BMC_COMM_TC_022_1  check all sensor list minipack2
...
FB_BMC_COMM_TC_023_Fan_Speed_Manual_Control
    ...
    [Tags]     common  FB_BMC_COMM_TC_023_Fan_Speed_Manual_Control  minipack2  
    [Timeout]  10 min 00 seconds
    [Setup]  set time delay  60
...
## this case's command is old, need wait for new command --Jeff 03/26/2021
#FB_BMC_COMM_TC_033_WD1_Test
 #   [Documentation]  This test verifies when WD1 be activated, system will auto reboot when stop feeding
  #  [Tags]     common  FB_BMC_COMM_TC_033_WD1_Test  minipack2  
   # [Timeout]  40 min 00 seconds
...
FB_BMC_COMM_TC_034_SCM_EEPROM_R/W_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_034_SCM_EEPROM_R/W_Test  minipack2
    [Timeout]  35 min 00 seconds
    [Setup]  prepare store eeprom  ${scm_eeprom_path}  SCM
    Sub-Case  FB_BMC_COMM_TC_034_1  run command to read scm eeprom
    Sub-Case  FB_BMC_COMM_TC_034_2  run command to write and read scm eeprom minipack2
    ...
    Sub-Case  FB_BMC_COMM_TC_034_5  run command to write and read scm eeprom with different data minipack2
...
FB_BMC_COMM_TC_035_SMB_EEPROM_R/W_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_035_SMB_EEPROM_R/W_Test  minipack2
    [Timeout]  35 min 00 seconds
    ...
    Sub-Case  FB_BMC_COMM_TC_035_2  run command to write and read smb eeprom minipack2
    ...
    Sub-Case  FB_BMC_COMM_TC_035_5  run command to write and read smb eeprom with different data minipack2
    Sub-Case  FB_BMC_COMM_TC_035_6  reset bmc and read smb eeprom with different data
    [Teardown]  restore smb eeprom minipack2

FB_BMC_COMM_TC_036_FCB_EEPROM_R/W_Test
    [Documentation]  This test verifies FCB EEPROM could be R/W successfully
    [Tags]     common  FB_BMC_COMM_TC_036_FCB_EEPROM_R/W_Test  minipack2
    [Timeout]  45 min 00 seconds
    [Setup]  prepare store fcb eeprom minipack2
    Sub-Case  FB_BMC_COMM_TC_036_1  run command to read fcb eeprom minipack2
    Sub-Case  FB_BMC_COMM_TC_036_2  run command to write and read fcb eeprom minipack2
    Sub-Case  FB_BMC_COMM_TC_036_3  reset bmc and read fcb eeprom minipack2
    Sub-Case  FB_BMC_COMM_TC_036_4  chassis power cycle and read fcb eeprom minipack2
    Sub-Case  FB_BMC_COMM_TC_036_5  run command to write and read fcb eeprom with different data minipack2
    Sub-Case  FB_BMC_COMM_TC_036_6  reset bmc and read fcb eeprom with different data minipack2
    [Teardown]  restore fcb eeprom minipack2

FB_BMC_COMM_TC_037_FAN_EEPROM_R/W_Test
    [Documentation]  This test verifies FAN EEPROM could be R/W successfully
    [Tags]     common  FB_BMC_COMM_TC_037_FAN_EEPROM_R/W_Test  minipack2  
...
FB_BMC_COMM_TC_038_AC_PSU_EEPROM_Access_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_038_AC_PSU_EEPROM_Access_Test  minipack2
    [Timeout]  10 min 00 seconds
    Sub-Case  FB_BMC_COMM_TC_038_1  read ac psu eeprom minipack2

FB_BMC_COMM_TC_039_eMMC_R/W_Test
    [Documentation]  This test verifies eMMC can be R/W successfully without any error
    [Tags]     common  FB_BMC_COMM_TC_039_eMMC_R/W_Test  minipack2  
    [Timeout]  40 min 00 seconds
...
FB_BMC_COMM_TC_040_Restful_fruid_test
    ...
    [Tags]     common  FB_BMC_COMM_TC_040_Restful_fruid_test  minipack2  
    [Timeout]  10 min 00 seconds
...
FB_BMC_COMM_TC_041_Restful_BMC_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_041_Restful_BMC_Test  minipack2  
    [Timeout]  10 min 00 seconds
    [Setup]  set time delay 90 and ssh login bmc
...
FB_BMC_COMM_TC_043_Restful_Status_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_043_Restful_Status_Test  minipack2  
    [Timeout]  10 min 00 seconds
    [Setup]  set time delay  90
...
FB_BMC_COMM_TC_045_weutil_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_045_weutil_Test  minipack2
    [Timeout]  10 min 00 seconds
    Sub-Case  FB_BMC_COMM_TC_045_1  run weutil command
    Sub-Case  FB_BMC_COMM_TC_045_2  check sim fru data match with weutil command
    [Teardown]  change dir
...
FB_BMC_COMM_TC_046_feutil_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_046_feutil_Test  minipack2
    [Timeout]  20 min 00 seconds
    Sub-Case  FB_BMC_COMM_TC_046_1  run feutil command minipack2
    Sub-Case  FB_BMC_COMM_TC_046_2  check fan and fcm fru data match with feutil command minipack2
    [Teardown]  change dir

FB_BMC_COMM_TC_047_seutil_Test
    [Documentation]  This test verifies the utility could be executed successfully
    [Tags]     common  FB_BMC_COMM_TC_047_seutil_Test  minipack2  
    [Timeout]  10 min 00 seconds
...
FB_BMC_COMM_TC_048_BIC_Utility_Test
    [Documentation]  This test verifies the utility could be executed successfully with all support parameters
    [Tags]     common  FB_BMC_COMM_TC_048_BIC_Utility_Test  minipack2  
    [Timeout]  15 min 00 seconds
...
FB_BMC_COMM_TC_049_SPI_Utility_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_049_SPI_Utility_Test  minipack2  
...
FB_BMC_COMM_TC_050_Version_Utility_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_050_Version_Utility_Test  minipack2  
    [Timeout]  5 min 00 seconds
...
FB_BMC_COMM_TC_051_Presence_Utility_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_051_Presence_Utility_Test  minipack2  
    [Timeout]  3 min 00 seconds
    Sub-Case  FB_BMC_COMM_TC_051_1  run command to get fan/psu/pim/scm status

FB_BMC_COMM_TC_053_Sensor_Utility_Test
    [Documentation]  This test verifies the utility could be executed successfully with all support parameters
    [Tags]     common  FB_BMC_COMM_TC_053_Sensor_Utility_Test  minipack2
    [Timeout]  30 min 00 seconds
    [Setup]  run sdk script if TH4 present
    Sub-Case  FB_BMC_COMM_TC_053_1  run all the support parameters of sensor-util threshold minipack2
    Sub-Case  FB_BMC_COMM_TC_053_2  run all the support parameters of sensor-util history information minipack2
    Sub-Case  FB_BMC_COMM_TC_053_3  run all the support parameters of sensor-util history clear minipack2
    Sub-Case  FB_BMC_COMM_TC_053_4  run all the support parameters of sensor-util firmware information minipack2
    [Teardown]  change dir to default

FB_BMC_COMM_TC_054_PSU_Utility_Test_AC_PSU
    [Documentation]  This test verifies the utility could be executed successfully with all support parameters
    [Tags]     common  FB_BMC_COMM_TC_054_PSU_Utility_Test_AC_PSU  minipack2
    [Timeout]  5 min 00 seconds
    Sub-Case  FB_BMC_COMM_TC_054_1  run all the parameters of psu-util minipack2
...
FB_BMC_COMM_TC_055_Tftp_Client_Tool_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_055_Tftp_Client_Tool_Test  minipack2  
    [Timeout]  10 min 00 seconds
...
FB_BMC_COMM_TC_056_Get_Device_ID
    ...
    [Tags]     common  FB_BMC_COMM_TC_056_Get_Device_ID  minipack2  
    [Timeout]  40 min 00 seconds
...
FB_BMC_COMM_TC_057_Reset_BMC_From_Host
    ...
    [Tags]     common  FB_BMC_COMM_TC_057_Reset_BMC_From_Host  minipack2  
    [Timeout]  10 min 00 seconds
...
FB_BMC_COMM_TC_058_Get_Selftest_Results
    ...
    [Tags]     common  FB_BMC_COMM_TC_058_Get_Selftest_Results  minipack2  
    [Timeout]  30 min 00 seconds
...
FB_BMC_COMM_TC_059_Get_Device_GUID
    ...
    [Tags]     common  FB_BMC_COMM_TC_059_Get_Device_GUID  minipack2  
    [Timeout]  2 min 00 seconds
...
FB_BMC_COMM_TC_064_System_Info_Parameters_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_064_System_Info_Parameters_Test  minipack2  
    [Timeout]  15 min 00 seconds
...
FB_BMC_COMM_TC_066_Get_Lan_Configuration
    ...
    [Tags]     common  FB_BMC_COMM_TC_066_Get_Lan_Configuration  minipack2  
    [Timeout]  2 min 00 seconds
...
FB_BMC_COMM_TC_067_Get_SOL_Configuration
    ...
    [Tags]     common  FB_BMC_COMM_TC_067_Get_SOL_Configuration  minipack2  
    [Timeout]  2 min 00 seconds
...
FB_BMC_COMM_TC_070_Get_Board_ID
    ...
    [Tags]     common  FB_BMC_COMM_TC_070_Get_Board_ID  minipack2  
    [Timeout]  2 min 00 seconds
...
FB_BMC_COMM_TC_071_Get_Port80_Record
    ...
    [Tags]     common  FB_BMC_COMM_TC_071_Get_Port80_Record  minipack2  
    [Timeout]  2 min 00 seconds
...
FB_BMC_COMM_TC_072_Get_PCIE_Configuration
    ...
    [Tags]     common  FB_BMC_COMM_TC_072_Get_PCIE_Configuration  minipack2  
    [Timeout]  2 min 00 seconds
...
FB_BMC_COMM_TC_073_Set_POST_Start
    ...
    [Tags]     common  FB_BMC_COMM_TC_073_Set_POST_Start  minipack2  
    [Timeout]  2 min 00 seconds
    Sub-Case  FB_BMC_COMM_TC_073_1  issue "set post start" command

FB_BMC_COMM_TC_074_Set_POST_End
    [Documentation]  This test verifies the OEM command can be executed successfully
    [Tags]     common  FB_BMC_COMM_TC_074_Set_POST_End  minipack2  
    [Timeout]  2 min 00 seconds
...
FB_BMC_COMM_TC_076_DIMM_Information_Get/Set_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_076_DIMM_Information_Get/Set_Test  minipack2  
    [Timeout]  20 min 00 seconds
    [Setup]  go to centos
...
FB_BMC_COMM_TC_077_Processor_Information_Get/Set_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_077_Processor_Information_Get/Set_Test  minipack2  
    [Timeout]  15 min 00 seconds
    [Setup]  go to centos
...
FB_BMC_COMM_TC_084_OpenBMC_Memory_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_084_OpenBMC_Memory_Test  minipack2  
    [Timeout]  30 min 00 seconds
...
FB_BMC_COMM_TC_085_SOL_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_085_SOL_Test  minipack2  
    [Timeout]  10 min 00 seconds
    [Setup]    go to openbmc
...
FB_BMC_COMM_TC_086_CPLD_Register_R/W_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_086_CPLD_Register_R/W_Test  minipack2  
    [Timeout]  15 min 00 seconds
...
FB_BMC_COMM_TC_087_TPM_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_087_TPM_Test  minipack2  
    [Timeout]  30 min 00 seconds
...
FB_BMC_COMM_TC_089_MDIO_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_089_MDIO_Test  minipack2
    [Timeout]  4 min 00 seconds
    Sub-Case  FB_BMC_COMM_TC_089_1  run command to read mdio reg minipack2
    Sub-Case  FB_BMC_COMM_TC_089_2  run command to write and read mdio reg minipack2
    Sub-Case  FB_BMC_COMM_TC_089_3  run command to write and read mdio reg again minipack2
    [Teardown]  run command to write mdio to default value minipack2

FB_BMC_COMM_TC_090_CIT_Test
    [Documentation]  This test verifies CIT Test
    [Tags]     common  FB_BMC_COMM_TC_090_CIT_Test  minipack2
    [Timeout]  60 min 00 seconds
    [Setup]  prepare CIT scripts and check pem presence
    Sub-Case  FB_BMC_COMM_TC_090_1  install and run cit test mp2
...
FB_BMC_COMM_TC_091_COMe_Mac_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_091_COMe_Mac_Test  minipack2
    [Timeout]  5 min 00 seconds
    [Setup]    go to openbmc
    Sub-Case  FB_BMC_COMM_TC_090_1  check come side mac address
    [Teardown]  change dir

# #### temporary comment because SW issue
# release it because of support it now --Jeff Gong 3/30
FB_BMC_MP2_TC_001_Online_Update_TH4_PCIE_FW_in_BMC_OS
    [Documentation]  This test checks the BMC FW programming functions by updating TH4 PCIE FW in BMC OS
    [Tags]     common  FB_BMC_MP2_TC_001_Online_Update_TH4_PCIE_FW_in_BMC_OS  minipack2  critical
    [Timeout]  60 min 00 seconds
    [Setup]  check TH4 chip presence
    Sub-Case  FB_BMC_MP2_TC_001_1  upgrade th4 fw if TH4 present
    #### temporary comment because TH4 now have only one version
    Sub-Case  FB_BMC_MP2_TC_001_2  downgrade th4 fw if TH4 present
    Sub-Case  FB_BMC_MP2_TC_001_1  upgrade th4 fw if TH4 present
    [Teardown]  Run Keyword If Test Failed  reset power chassis  DUT

FB_BMC_MP2_TC_002_Online_Update_AC_PSU_FW_In_BMC_OS
    [Documentation]  This test checks the BMC FW programming functions by updating the AC PSU FW in BMC OS
    [Tags]     common  FB_BMC_MP2_TC_002_Online_Update_AC_PSU_FW_In_BMC_OS  minipack2  critical
    [Timeout]  60 min 00 seconds
    [Setup]  prepare PSU images
    Sub-Case  FB_BMC_MP2_TC_001_1  upgrade psu1 fw
    Sub-Case  FB_BMC_MP2_TC_001_2  downgrade psu1 fw
    Sub-Case  FB_BMC_MP2_TC_001_3  upgrade psu1 fw
    Sub-Case  FB_BMC_MP2_TC_001_4  upgrade psu2 fw
    Sub-Case  FB_BMC_MP2_TC_001_5  downgrade psu2 fw
    Sub-Case  FB_BMC_MP2_TC_001_6  upgrade psu2 fw
    Sub-Case  FB_BMC_MP2_TC_001_7  upgrade psu3 fw
    Sub-Case  FB_BMC_MP2_TC_001_8  downgrade psu3 fw
    Sub-Case  FB_BMC_MP2_TC_001_9  upgrade psu3 fw
    Sub-Case  FB_BMC_MP2_TC_001_10  upgrade psu4 fw
    Sub-Case  FB_BMC_MP2_TC_001_11  downgrade psu4 fw
    Sub-Case  FB_BMC_MP2_TC_001_12  upgrade psu4 fw
    Sub-Case  FB_BMC_MP2_TC_001_13  chassis power cycle and check psu info and status if psu power on
    [Teardown]  clean images  DUT  PSU

FB_BMC_MP2_TC_003_Online_Update_DC_PSU_FW_In_BMC_OS
    [Documentation]  This test checks the BMC FW programming functions by updating the DC PSU FW in BMC OS
    [Tags]     common  FB_BMC_MP2_TC_003_Online_Update_DC_PSU_FW_In_BMC_OS  minipack2  critical
    [Timeout]  60 min 00 seconds
    [Setup]  prepare dc PSU images
    Sub-Case  FB_BMC_MP2_TC_001_1  upgrade dc psu1 fw
    Sub-Case  FB_BMC_MP2_TC_001_2  downgrade dc psu1 fw
    Sub-Case  FB_BMC_MP2_TC_001_3  upgrade dc psu1 fw
    Sub-Case  FB_BMC_MP2_TC_001_4  upgrade dc psu2 fw
    Sub-Case  FB_BMC_MP2_TC_001_5  downgrade dc psu2 fw
    Sub-Case  FB_BMC_MP2_TC_001_6  upgrade dc psu2 fw
    Sub-Case  FB_BMC_MP2_TC_001_7  upgrade dc psu3 fw
    Sub-Case  FB_BMC_MP2_TC_001_8  downgrade dc psu3 fw
    Sub-Case  FB_BMC_MP2_TC_001_9  upgrade dc psu3 fw
    Sub-Case  FB_BMC_MP2_TC_001_10  upgrade dc psu4 fw
    Sub-Case  FB_BMC_MP2_TC_001_11  downgrade dc psu4 fw
    Sub-Case  FB_BMC_MP2_TC_001_12  upgrade dc psu4 fw
    Sub-Case  FB_BMC_MP2_TC_001_13  chassis power cycle and check psu info and status if psu power on
    [Teardown]  clean images  DUT  PSU

FB_BMC_MP2_TC_004_PIM_EEPROM_R/W_Test
    [Documentation]  This test verifies PIM EEPROM could be R/W successfully
    [Tags]     common  FB_BMC_MP2_TC_004_PIM_EEPROM_R/W_Test  minipack2
    [Timeout]  90 min 00 seconds
    [Setup]  prepare store all pim eeprom
    Sub-Case  FB_BMC_MP2_TC_004_1  run command to read pim eeprom
    Sub-Case  FB_BMC_MP2_TC_004_2  run command to write and read pim eeprom
    Sub-Case  FB_BMC_MP2_TC_004_3  reset bmc and read pim eeprom
    Sub-Case  FB_BMC_MP2_TC_004_4  chassis power cycle and read pim eeprom
    Sub-Case  FB_BMC_MP2_TC_004_5  run command to write and read pim eeprom with different data
    Sub-Case  FB_BMC_MP2_TC_004_6  reset bmc and read pim eeprom with different data
    [Teardown]  restore all pim eeprom

FB_BMC_MP2_TC_005_SIM_EEPROM_R/W_Test
    [Documentation]  This test verifies SIM EEPROM could be R/W successfully
    [Tags]     common  FB_BMC_MP2_TC_005_SIM_EEPROM_R/W_Test  minipack2
    [Timeout]  35 min 00 seconds
    [Setup]  prepare store eeprom  ${sim_eeprom_path}  SIM
    Sub-Case  FB_BMC_MP2_TC_005_1  run command to read sim eeprom
    Sub-Case  FB_BMC_MP2_TC_005_2  run command to write and read sim eeprom
    Sub-Case  FB_BMC_MP2_TC_005_3  reset bmc and read sim eeprom
    Sub-Case  FB_BMC_MP2_TC_005_4  chassis power cycle and read sim eeprom
    Sub-Case  FB_BMC_MP2_TC_005_5  run command to write and read sim eeprom with different data
    Sub-Case  FB_BMC_MP2_TC_005_6  reset bmc and read sim eeprom with different data
    [Teardown]  restore eeprom  ${sim_eeprom_path}  SIM

FB_BMC_MP2_TC_008_peutil_Test
    [Documentation]  This test verifies the utility could be executed successfully with all support parameters
    [Tags]     common  FB_BMC_MP2_TC_008_peutil_Test  minipack2
    [Timeout]  10 min 00 seconds
    Sub-Case  FB_BMC_MP2_TC_008_1  run peutil command
    Sub-Case  FB_BMC_MP2_TC_008_2  check pim data match with peutil command
    [Teardown]  change dir

FB_BMC_MP2_TC_009_beutil_Test
    [Documentation]  This test verifies the utility could be executed successfully with all support parameters
    [Tags]     common  FB_BMC_MP2_TC_009_beutil_Test  minipack2
    [Timeout]  3 min 00 seconds
    Sub-Case  FB_BMC_MP2_TC_009_1  run beutil command
    Sub-Case  FB_BMC_MP2_TC_009_2  check bmc data match with beutil command
    [Teardown]  change dir

FB_BMC_MP2_TC_010_smbutil_Test
    [Documentation]  This test verifies the utility could be executed successfully with all support parameters
    [Tags]     common  FB_BMC_MP2_TC_010_smbutil_Test  minipack2
    [Timeout]  3 min 00 seconds
    Sub-Case  FB_BMC_MP2_TC_010_1  run smbutil command
    Sub-Case  FB_BMC_MP2_TC_010_2  check smb data match with smbutil command
    [Teardown]  change dir

FB_BMC_MP2_TC_011_otp_util_Test
    [Documentation]  This test verifies otp util Test
    [Tags]     common  FB_BMC_MP2_TC_011_otp_util_Test  minipack2
    [Timeout]  20 min 00 seconds
    [Setup]    switch bmc flash to Master
    Sub-Case  FB_BMC_COMM_TC_011_1  check bmc auto boot test
    [Teardown]  change dir
