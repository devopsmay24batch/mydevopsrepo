...
BMC_COMM_TC_000_Online_Update_slave_BMC_and_diag
    ...
    [Tags]     common  BMC_COMM_TC_000_Online_Update_slave_BMC_and_diag  wedge400c  critical
    [Timeout]  180 min 00 seconds
#[Setup]    prepare BMC and diag images
    [Setup]    prepare BMC images
    Sub-Case  FB_BMC_COMM_TC_000_1  upgrade master bmc and check version
#Sub-Case  FB_BMC_COMM_TC_000_2  install diag package and init diag

FB_BMC_COMM_TC_003_Online_Update_BMC_in_BMC_OS
    [Documentation]  This test checks the BMC FW programming functions by updating the BMC FW in BMC OS
    [Tags]     common  FB_BMC_COMM_TC_003_Online_Update_BMC_in_BMC_OS  wedge400c  critical
...
FB_BMC_COMM_TC_004_OpenBMC_Uart_Information_Check
    ...
    [Tags]     common  FB_BMC_COMM_TC_004_OpenBMC_Uart_Information_Check  wedge400c
...
FB_BMC_COMM_TC_005_Online_Update_BIOS_in_BMC_OS
    ...
    [Tags]     common  FB_BMC_COMM_TC_005_Online_Update_BIOS_in_BMC_OS  wedge400c  critical
    [Timeout]  150 min 00 seconds
...
FB_BMC_COMM_TC_006_Online_update_CPLD_in_BMC_OS
    ...
    [Tags]     common  FB_BMC_COMM_TC_006_Online_update_CPLD_in_BMC_OS  wedge400c  critical
    [Timeout]  150 min 00 seconds
...
FB_BMC_COMM_TC_007_Online_Update_BIC_Bridge_in_BMC_OS
    ...
    [Tags]     common  FB_BMC_COMM_TC_007_Online_Update_BIC_Bridge_in_BMC_OS  wedge400c  critical
...
FB_BMC_COMM_TC_008_BIC_Frequency_Auto_Set_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_008_BIC_Frequency_Auto_Set_Test  wedge400c
    [Timeout]  40 min 00 seconds
...
FB_BMC_COMM_TC_009_Online_Update_FPGA_In_BMC_OS
    ...
    [Tags]     common  FB_BMC_COMM_TC_009_Online_Update_FPGA_In_BMC_OS  wedge400c  critical
...
#    [Tags]     common  FB_BMC_COMM_TC_010_Online_Update_OOB_Switch_FW_in_BMC_OS  wedge400c
...
FB_BMC_COMM_TC_011_Backup_BMC_Manual_Booting_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_011_Backup_BMC_Manual_Booting_Test  wedge400c
...
FB_BMC_COMM_TC_013_Backup_BIOS_Manual_Booting_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_013_Backup_BIOS_Manual_Booting_Test  wedge400c
...
FB_BMC_COMM_TC_014_BMC_Network_Config_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_014_BMC_Network_Config_Test  wedge400c
...
FB_BMC_COMM_TC_016_IPv6_Ping_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_016_IPv6_Ping_Test  wedge400c
    [Timeout]  10 min 00 seconds
...
FB_BMC_COMM_TC_017_IPv6_SSH_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_017_IPv6_SSH_Test  wedge400c
    [Timeout]  10 min 00 seconds
...
FB_BMC_COMM_TC_018_Internal_USB_Network_Check
    ...
    [Tags]     common  FB_BMC_COMM_TC_018_Internal_USB_Network_Check  wedge400c
...
FB_BMC_COMM_TC_019_OpenBMC_MAC_Address_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_019_OpenBMC_MAC_Address_Test  wedge400c
...
FB_BMC_COMM_TC_020_Power_Control
    ...
    [Tags]     common  FB_BMC_COMM_TC_020_Power_Control  wedge400c
    [Timeout]  40 min 00 seconds
...
FB_BMC_COMM_TC_021_OpenBMC_Reset_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_021_OpenBMC_Reset_Test  wedge400c
...
FB_BMC_COMM_TC_022_Sensor_Info_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_022_Sensor_Info_Test  wedge400c
    [Timeout]  30 min 00 seconds
    [Setup]  set time delay  60
    Sub-Case  FB_BMC_COMM_TC_022_1  check all sensor list
...
FB_BMC_COMM_TC_023_Fan_Speed_Manual_Control
    ...
    [Tags]     common  FB_BMC_COMM_TC_023_Fan_Speed_Manual_Control  wedge400c
    [Timeout]  10 min 00 seconds
    [Setup]  set time delay  60
...
FB_BMC_COMM_TC_032_GPIO_Config
    ...
    [Tags]     common  FB_BMC_COMM_TC_032_GPIO_Config  wedge400c
    [Timeout]  15 min 00 seconds
...
FB_BMC_COMM_TC_033_WD1_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_033_WD1_Test  wedge400c
    [Timeout]  40 min 00 seconds
...
FB_BMC_COMM_TC_034_SCM_EEPROM_R/W_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_034_SCM_EEPROM_R/W_Test  wedge400c
...
FB_BMC_COMM_TC_035_SMB_EEPROM_R/W_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_035_SMB_EEPROM_R/W_Test  wedge400c
    [Timeout]  35 min 00 seconds
...
FB_BMC_COMM_TC_036_FCB_EEPROM_R/W_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_036_FCB_EEPROM_R/W_Test  wedge400c
    [Timeout]  45 min 00 seconds
...
FB_BMC_COMM_TC_037_FAN_EEPROM_R/W_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_037_FAN_EEPROM_R/W_Test  wedge400c
...
FB_BMC_COMM_TC_038_AC_PSU_EEPROM_Access_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_038_AC_PSU_EEPROM_Access_Test  wedge400c
    [Timeout]  10 min 00 seconds
...
FB_BMC_COMM_TC_039_eMMC_R/W_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_039_eMMC_R/W_Test  wedge400c
    [Timeout]  40 min 00 seconds
...
FB_BMC_COMM_TC_040_Restful_fruid_test
    ...
    [Tags]     common  FB_BMC_COMM_TC_040_Restful_fruid_test  wedge400c
    [Timeout]  10 min 00 seconds
...
FB_BMC_COMM_TC_041_Restful_BMC_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_041_Restful_BMC_Test  wedge400c
    [Timeout]  10 min 00 seconds
    [Setup]  set time delay  90
...
FB_BMC_COMM_TC_042_Restful_Sensors_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_042_Restful_Sensors_Test  wedge400c
    [Timeout]  10 min 00 seconds
    [Setup]  set time delay  90
...
FB_BMC_COMM_TC_043_Restful_Status_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_043_Restful_Status_Test  wedge400c
    [Timeout]  10 min 00 seconds
    [Setup]  set time delay  90
...
FB_BMC_COMM_TC_045_weutil_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_045_weutil_Test  wedge400c
    [Timeout]  10 min 00 seconds
...
FB_BMC_COMM_TC_046_feutil_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_046_feutil_Test  wedge400c
    [Timeout]  10 min 00 seconds
...
FB_BMC_COMM_TC_047_seutil_Test
    [Documentation]  This test verifies the utility could be executed successfully
    [Tags]     common  FB_BMC_COMM_TC_047_seutil_Test  wedge400c
    [Timeout]  10 min 00 seconds
...
FB_BMC_COMM_TC_048_BIC_Utility_Test
    [Documentation]  This test verifies the utility could be executed successfully with all support parameters
    [Tags]     common  FB_BMC_COMM_TC_048_BIC_Utility_Test  wedge400c
    [Timeout]  15 min 00 seconds
...
FB_BMC_COMM_TC_049_SPI_Utility_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_049_SPI_Utility_Test  wedge400c
...
FB_BMC_COMM_TC_050_Version_Utility_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_050_Version_Utility_Test  wedge400c
    [Timeout]  5 min 00 seconds
...
FB_BMC_COMM_TC_051_Presence_Utility_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_051_Presence_Utility_Test  wedge400c
...
FB_BMC_COMM_TC_053_Sensor_Utility_Test
    [Documentation]  This test verifies the utility could be executed successfully with all support parameters
    [Tags]     common  FB_BMC_COMM_TC_053_Sensor_Utility_Test  wedge400c
    [Timeout]  30 min 00 seconds
    [Setup]  run sdk script and check pem presence device
...
FB_BMC_COMM_TC_054_PSU_Utility_Test_AC_PSU
    [Documentation]  This test verifies the utility could be executed successfully with all support parameters
    [Tags]     common  FB_BMC_COMM_TC_054_PSU_Utility_Test_AC_PSU  wedge400c
    [Timeout]  5 min 00 seconds
...
FB_BMC_COMM_TC_055_Tftp_Client_Tool_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_055_Tftp_Client_Tool_Test  wedge400c
    [Timeout]  10 min 00 seconds
...
FB_BMC_COMM_TC_056_Get_Device_ID
    ...
    [Tags]     common  FB_BMC_COMM_TC_056_Get_Device_ID  wedge400c
    [Timeout]  40 min 00 seconds
...
FB_BMC_COMM_TC_057_Reset_BMC_From_Host
    ...
    [Tags]     common  FB_BMC_COMM_TC_057_Reset_BMC_From_Host  wedge400c
    [Timeout]  10 min 00 seconds
...
FB_BMC_COMM_TC_058_Get_Selftest_Results
    ...
    [Tags]     common  FB_BMC_COMM_TC_058_Get_Selftest_Results  wedge400c
    [Timeout]  30 min 00 seconds
...
FB_BMC_COMM_TC_059_Get_Device_GUID
    ...
    [Tags]     common  FB_BMC_COMM_TC_059_Get_Device_GUID  wedge400c
    [Timeout]  2 min 00 seconds
...
FB_BMC_COMM_TC_064_System_Info_Parameters_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_064_System_Info_Parameters_Test  wedge400c
    [Timeout]  15 min 00 seconds
    ...
    [Teardown]  Run Keyword If Test Failed  power cycle unit
...
FB_BMC_COMM_TC_066_Get_Lan_Configuration
    ...
    [Tags]     common  FB_BMC_COMM_TC_066_Get_Lan_Configuration  wedge400c
    [Timeout]  2 min 00 seconds
...
FB_BMC_COMM_TC_067_Get_SOL_Configuration
    ...
    [Tags]     common  FB_BMC_COMM_TC_067_Get_SOL_Configuration  wedge400c
    [Timeout]  2 min 00 seconds
...
FB_BMC_COMM_TC_070_Get_Board_ID
    ...
    [Tags]     common  FB_BMC_COMM_TC_070_Get_Board_ID  wedge400c
    [Timeout]  2 min 00 seconds
...
FB_BMC_COMM_TC_071_Get_Port80_Record
    ...
    [Tags]     common  FB_BMC_COMM_TC_071_Get_Port80_Record  wedge400c
    [Timeout]  2 min 00 seconds
...
FB_BMC_COMM_TC_072_Get_PCIE_Configuration
    ...
    [Tags]     common  FB_BMC_COMM_TC_072_Get_PCIE_Configuration  wedge400c
    [Timeout]  2 min 00 seconds
...
FB_BMC_COMM_TC_073_Set_POST_Start
    ...
    [Tags]     common  FB_BMC_COMM_TC_073_Set_POST_Start  wedge400c
    [Timeout]  2 min 00 seconds
    Sub-Case  FB_BMC_COMM_TC_073_1  issue "set post start" command

FB_BMC_COMM_TC_074_Set_POST_End
    [Documentation]  This test verifies the OEM command can be executed successfully
    [Tags]     common  FB_BMC_COMM_TC_074_Set_POST_End  wedge400c
    [Timeout]  2 min 00 seconds
...
FB_BMC_COMM_TC_076_DIMM_Information_Get/Set_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_076_DIMM_Information_Get/Set_Test  wedge400c
    [Timeout]  20 min 00 seconds
    [Setup]  go to centos
...
FB_BMC_COMM_TC_077_Processor_Information_Get/Set_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_077_Processor_Information_Get/Set_Test  wedge400c
    [Timeout]  15 min 00 seconds
    [Setup]  go to centos
...
FB_BMC_COMM_TC_084_OpenBMC_Memory_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_084_OpenBMC_Memory_Test  wedge400c
    [Timeout]  30 min 00 seconds
...
FB_BMC_COMM_TC_085_SOL_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_085_SOL_Test  wedge400c
    [Timeout]  10 min 00 seconds
    [Setup]    go to openbmc
...
FB_BMC_COMM_TC_086_CPLD_Register_R/W_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_086_CPLD_Register_R/W_Test  wedge400c
    [Timeout]  15 min 00 seconds
...
FB_BMC_COMM_TC_087_TPM_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_087_TPM_Test  wedge400c
    [Timeout]  30 min 00 seconds
...
FB_BMC_COMM_TC_089_MDIO_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_089_MDIO_Test  wedge400c
...
FB_BMC_COMM_TC_090_CIT_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_090_CIT_Test  wedge400c
    [Timeout]  60 min 00 seconds
    [Setup]  prepare CIT scripts and check pem presence
    Sub-Case  FB_BMC_COMM_TC_090_1  install and run cit test
    [Teardown]  clean cit script and change dir

FB_BMC_W400C_TC_001_Online_Update_AC_PSU_FW_in_BMC_OS
    [Documentation]  This test checks the BMC FW programming functions by updating the AC PSU FW in BMC OS
    [Tags]     wedge400c  FB_BMC_W400C_TC_001_Online_Update_AC_PSU_FW_in_BMC_OS  critical
    [Timeout]  40 min 00 seconds
    [Setup]  prepare PSU images
    Sub-Case  FB_BMC_W400C_TC_001_1  upgrade psu1 fw
    Sub-Case  FB_BMC_W400C_TC_001_2  downgrade psu1 fw
    Sub-Case  FB_BMC_W400C_TC_001_3  upgrade psu2 fw
    Sub-Case  FB_BMC_W400C_TC_001_4  downgrade psu2 fw
    Sub-Case  FB_BMC_W400C_TC_001_5  upgrade psu1 fw
    Sub-Case  FB_BMC_W400C_TC_001_6  upgrade psu2 fw
    Sub-Case  FB_BMC_W400C_TC_001_7  chassis power cycle and check psu info and status if psu power on
    [Teardown]  clean images  DUT  PSU

FB_BMC_W400C_TC_002_Online_Update_DC_PSU_FW_in_BMC_OS
    [Documentation]  This test checks the BMC FW programming functions by updating the PSU FW in BMC OS
    [Tags]     wedge400c  FB_BMC_W400C_TC_002_Online_Update_DC_PSU_FW_in_BMC_OS  critical
    [Timeout]  60 min 00 seconds
    [Setup]  prepare dc PSU images
    Sub-Case  FB_BMC_W400C_TC_001_1  upgrade dc psu1 fw
    Sub-Case  FB_BMC_W400C_TC_001_2  downgrade dc psu1 fw
    Sub-Case  FB_BMC_W400C_TC_001_3  upgrade dc psu1 fw
    Sub-Case  FB_BMC_W400C_TC_001_4  upgrade dc psu2 fw
    Sub-Case  FB_BMC_W400C_TC_001_5  downgrade dc psu2 fw
    Sub-Case  FB_BMC_W400C_TC_001_6  upgrade dc psu2 fw
    Sub-Case  FB_BMC_W400C_TC_001_7  chassis power cycle and check psu info and status if psu power on
    [Teardown]  clean images  DUT  PSU

FB_BMC_W400C_TC_003_PEM_EEPROM_R/W_Test
    [Documentation]  This test verifies PEM EEPROM can be R/W successfully
    [Tags]     wedge400c  FB_BMC_W400C_TC_003_PEM_EEPROM_R/W_Test
    [Timeout]  35 min 00 seconds
...
FB_BMC_W400C_TC_006_RackmonTest
    ...
    [Tags]     wedge400c  FB_BMC_W400C_TC_006_RackmonTest
    [Timeout]  20 min 00 seconds
...
FB_BMC_W400C_TC_007_bsm-eutil_Test
    [Documentation]  This test verifies the utility could be executed successfully
    [Tags]     wedge400c  FB_BMC_W400C_TC_007_bsm-eutil_Test
    [Timeout]  2 min 00 seconds
...
FB_BMC_COMM_TC_091_COMe_Mac_Test
    ...
    [Tags]     common  FB_BMC_COMM_TC_091_COMe_Mac_Test  wedge400c
    [Timeout]  5 min 00 seconds
    [Setup]    go to openbmc
