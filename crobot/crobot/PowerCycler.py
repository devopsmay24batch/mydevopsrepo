...
class PowerCycler(TelnetDevice):

    def __init__(self, powerCyclerDict, powerCyclerPort):
        super().__init__()

        log.debug("Entering PowerCycler class procedure: __init__")
        self.userName = powerCyclerDict['userName']
        self.password = powerCyclerDict['password']
        self.managementIP = powerCyclerDict['managementIP']
        self.managementPort = powerCyclerDict['managementPort']
        self.managementPrompt = powerCyclerDict['managementPrompt']
        self.powerCyclerPort = powerCyclerPort
    ...
    def login(self):
        ...
        try:
            ...
            output = self.readUntil("UserName :")
    ...
    def powerCycleDevice(self):
        ...
        log.debug("Entering powerCycleDevice class procedure: powerCycleDevice")
        log.debug("powerCyclerPort=[%s]" %str(self.powerCyclerPort))
        ...
        log.debug('issue telnet command')
