...
Variables       lagavulin/JuniperDiagAberlourVariables.py
#Resource        JuniperCommonKeywords.resource
#Resource        JuniperDiagKeywords.resource
Library         JuniperAberlourDiagLib.py
...
ABERLOUR_DIAG_9.1_CPU_Information_Test
     [Documentation]  To test CPU Information
     [Tags]  ABERLOUR_DIAG_9.1_CPU_Information_Test  aberlour  
...
ABERLOUR_DIAG_9.2_Memory_Test
     [Documentation]  Memory Test
     [Tags]  ABERLOUR_DIAG_9.2_Memory_Test  aberlour  
     Step  1  verify diag tool path
...
ABERLOUR_DIAG_10.1_I2C_Device_Test
     [Documentation]  I2C Device Test
     [Tags]  ABERLOUR_DIAG_10.1_I2C_Device_Test  aberlour
     Step  1  verify diag tool path
...
ABERLOUR_DIAG_9.5_Mgmt_Ether_Port_Connect_Test
     [Documentation]  Mgmt Ether Port Connect Test
     [Tags]  ABERLOUR_DIAG_9.5_Mgmt_Ether_Port_Connect_Test  aberlour  
     Step  1  verify diag tool path
...
ABERLOUR_DIAG_10.5_CPLD_Access_Test
     [Documentation]  CPLD Acces test
     [Tags]  ABERLOUR_DIAG_10.5_CPLD_Access_Test  aberlour 
     Step  1  verify diag tool path
...
ABERLOUR_DIAG_11.2_RTC_and_Battery_Test
     [Documentation]  RTc and Battery test
     [Tags]  ABERLOUR_DIAG_11.2_RTC_and_Battery_Test  aberlour 
     Step  1  verify diag tool path
     Step  2  rtc help parameter
     Step  3  rtc version parameter
     Step  4  set and read rtc time

ABERLOUR_DIAG_11.6_Power_Monitor_Test
     [Documentation]  Power Monitor Test
     [Tags]  ABERLOUR_DIAG_11.6_Power_Monitor_Test  aberlour 
     Step  1  verify diag tool path
...
ABERLOUR_11.14_Down_SFP_Test
     [Documentation]  Down SFP Test
     [Tags]  ABERLOUR_11.14_Down_SFP_Test  aberlour_48F 
     Step  1  Check DUT support SFP test
     Step  2  SFP tool path  
     Step  3  Down SFP test 

ABERLOUR_DIAG_11.8_Firmware/Software_Information_Test 
     [Documentation]  Firmware/Software Information Test
     [Tags]  ABERLOUR_DIAG_11.8_Firmware/Software_Information_Test  aberlour  
     Step  1  verify diag tool path
...
ABERLOUR_DIAG_11.22_LPC_Access_Test
     [Documentation]  LPC Access Test
     [Tags]  ABERLOUR_DIAG_11.22_LPC_Access_Test  aberlour  
     Step  1  verify diag tool path
     Step  2  lpc help parameter
     Step  3  lpc read write operation 

ABERLOUR_DIAG_11.21_Check_The_Reset_Reason_Test
     [Documentation]  Check the Reset Reason Test
     [Tags]  ABERLOUR_DIAG_11.21_Check_The_Reset_Reason_Test  aberlour  
     Step  1  verify diag tool path
...
ABERLOUR_DIAG_11.25_SI_USB_Controller_Test
     [Documentation]  SI USB Controller Test
     [Tags]  ABERLOUR_DIAG_11.25_SI_USB_Controller_Test  aberlour  
     Step  1  verify tool path
     Step  2  enable relax security
     Step  3  get and set USB register value
     Step  4  disable relax security

ABERLOUR_DIAG_11.26_SI_SMBus_Controller_Test
     [Documentation]  SI SMBus Controller Test
     [Tags]  ABERLOUR_DIAG_11.26_SI_SMBus_Controller_Test  aberlour  
     Step  1  verify tool path
     Step  2  get and set SMBus clk value

ABERLOUR_DIAG_11.27_SI_Sata_Controller_Test
     [Documentation]  SI Sata Controller Test
     [Tags]  ABERLOUR_DIAG_11.27_SI_Sata_Controller_Test  aberlour  
     Step  1  verify tool path
     Step  2  enable relax security
     Step  3  set and read sata3 dword6 register value
     Step  4  disable relax security

ABERLOUR_DIAG_11.10_Module_FAN_Speed_SAT_stages_Test
     [Documentation]   Module FAN Speed SAT stages Test
     [Tags]   ABERLOUR_DIAG_11.10_Module_FAN_Speed_SAT_stages_Test  aberlour  
     [Timeout]  15 min 00 seconds
     Step  1  verify diag tool path
     Step  2  set fan speed  50  50  49


ABERLOUR_DIAG_11.11_Module_FAN_Speed_RIT/ORT_stages_Test
     [Documentation]   Module FAN Speed RIT/ORT stages Test
     [Tags]  ABERLOUR_DIAG_11.11_Module_FAN_Speed_RIT/ORT_stages_Test  aberlour   
     [Timeout]  15 min 00 seconds
     Step  1  verify diag tool path
     Step  2  set fan speed  100  100  100

ABERLOUR_DIAG_11.24_Cards_information_Test
     [Documentation]  The purpose of this test is to check the Card type is 24T/24P/48T/48P/48F and uplink card is 10G/25G mode.
     [Tags]  ABERLOUR_DIAG_11.24_Cards_information_Test  aberlour 
...
ABERLOUR_DIAG_1.3.36_TPM_Manufacture_Test
     [Documentation]  TPM Manufacture Test
     [Tags]  ABERLOUR_DIAG_1.3.36_TPM_Manufacture_Test  aberlour
     Step  1  verify diag tool path
     Step  2  run Tpm Manufacture Test

ABERLOUR_DIAG_15.6_DDR_stress_test
...
#    [Timeout]  43500 mins 00 seconds
    ...
    [Tags]  ABERLOUR_DIAG_15.6_DDR_stress_test  aberlour
    Step  1  check ddr test

ABERLOUR_DIAG_11.28_DDR_ECC_Test
     [Documentation]  DDR ECC Test
     [Tags]  ABERLOUR_DIAG_11.28_DDR_ECC_Test  aberlour  
     Step  1  verify diag tool path
...
ABERLOUR_DIAG_13.4_I210_fw_Update
     [Documentation]  To check diag tool Firmware upgrade function
     [Tags]  ABERLOUR_DIAG_13.4_I210_fw_Update  aberlour
     Step  1  verify diag tool path
     Step  2  check I210 Update

#ABERLOUR_DIAG_13.7_Com-e_Card_Power_Monitor_Online_Update
#   [Documentation]  The purpose of this test is to check diag tool Firmware upgrade function
#   [Tags]  ABERLOUR_DIAG_13.7_Com-e_Card_Power_Monitor_Online_Update  aberlour
...
ABERLOUR_DIAG_11.30_Boot_from_Golden_BIOS_Test
     [Documentation]  Boot from Golden BIOS Test
     [Tags]  ABERLOUR_DIAG_11.30_Boot_from_Golden_BIOS_Test  aberlour  
     Step  1  verify diag tool path
     Step  2  cpld help parameter
     Step  3  cpld list parameter
     Step  4  cpld version parameter
...
ABERLOUR_DIAG_11.31_EMMC_Test
     [Documentation]  EMMC Test
     [Tags]  ABERLOUR_DIAG_11.31_EMMC_Test  aberlour  
     Step  1  verify diag tool path
...
ABERLOUR_DIAG_15.7_Warm_Boot_stress_test
   [Documentation]  The purpose of this test is to check device reboot test.
   [Tags]  ABERLOUR_DIAG_15.7_Warm_Boot_stress_test  aberlour
   [Timeout]  250 mins 00 seconds
...
ABERLOUR_DIAG_16.2_FCT_Test_10G_and_25G_uplink_card
     [Documentation]  To test FCT - 10G and 25G uplink card
     [Tags]  ABERLOUR_DIAG_16.2_FCT_Test_10G_and_25G_uplink_card  aberlour
     Step  1  verify diag tool path
...
#ABERLOUR_DIAG_13.6_Switch_Card_Power_Monitor_Online_Update
#     [Documentation]  To check diag tool Firmware upgrade function
#     [Tags]  ABERLOUR_DIAG_13.6_Switch_Card_Power_Monitor_Online_Update  aberlour
#     Step  1  verify diag tool path
#     Step  2  check Switch Card Help
#     Step  3  check Switch Card Version
#     Step  4  update Image By Pwon

ABERLOUR_DIAG_13.8_eMMC_FFU
     [Documentation]  To check eMMC FFU upgrade function
     [Tags]  ABERLOUR_DIAG_13.8_eMMC_FFU  aberlour
     Step  1  verify diag tool path
     Step  2  upgrade Emmc Ffu

ABERLOUR_DIAG_11.33_Fly_back_cable_Voltage_drop_Test
     [Documentation]  To check fly back cable Voltage drop should be correct.
     [Tags]  ABERLOUR_DIAG_11.33_Fly_back_cable_Voltage_drop_Test  aberlour
     Step  1  verify diag tool path
     Step  2  execute Cable Voltage Drop Test

ABERLOUR_DIAG_11.20_FRU_EEPROM_Test
     [Documentation]   The purpose of this test is to check FRU eeprom
     [Tags]   ABERLOUR_DIAG_11.20_FRU_EEPROM_Test  aberlour
     [Timeout]  15 min 00 seconds
     Step  1  verify tool path
...
ABERLOUR_DIAG_15.3_Mgmt_Eth_Port_test
     [Documentation]   Management ethernet port stress test
     [Tags]  ABERLOUR_DIAG_15.3_Mgmt_Eth_Port_test  aberlour
     Step  1  iperf stress test

ABERLOUR_DIAG_11.7_DC/DC_Controller_Access_Test
     ...
     [Tags]  ABERLOUR_DIAG_11.7_DC/DC_Controller_Access_Test  aberlour
     [Timeout]  15 min 00 seconds
...
ABERLOUR_DIAG_13.2_System_CPLD_Update
     [Documentation]  System CPLD Update Test
     [Tags]  ABERLOUR_DIAG_13.2_System_CPLD_Update  aberlour
     LOG  ----------------------------!!! Semi-automated Test Case !!!-----------------------------
...
ABERLOUR_DIAG_13.3_CPU_CPLD_Update
     [Documentation]  To check diag tool Firmware upgrade function
     [Tags]  ABERLOUR_DIAG_13.3_CPU_CPLD_Update  aberlour
     LOG  ----------------------------!!! Semi-automated Test Case !!!-----------------------------
     LOG  ---------------------------- Step-2&3 Needs Manual Power Cycle! -------------------------
     Step  1  verify diag tool path
