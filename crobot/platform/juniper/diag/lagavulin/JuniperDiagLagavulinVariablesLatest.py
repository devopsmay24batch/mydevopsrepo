...
diag_old_version=SwImage.getSwImage(SwImage.DIAG).oldVersion
diag_new_version=SwImage.getSwImage(SwImage.DIAG).newVersion
diag_old_image=SwImage.getSwImage(SwImage.DIAG).oldImage
diag_new_image=SwImage.getSwImage(SwImage.DIAG).newImage
diag_image_copy_list = [diag_old_image, diag_new_image]
diag_image_server_path = SwImage.getSwImage(SwImage.DIAG).hostImageDir
diag_image_unit_path = SwImage.getSwImage(SwImage.DIAG).localImageDir
...
sfp_cmds = [
        "cd /root/Diag/lagavulin",
        "./bin/cel-cpld-test -w -d 1 -A 0x6a -D 0xb0",
        "cd /root/Diag/lagavulin/tools/oom/apps",
        "python inventory.py",
...
cpu_list = ['\[CPU_EEPROM\]',
  ...
  'assembly_revision              = REV 01',
  'assembly_pn                    = 650-107177',
  'assembly_sn                    = XC0219200001',
  'assembly_flag                  = 0x00',
  'assembly_manufacture_date      = 20190417',
  'reserved                       = 0xFFFF',
  'customer_identification        = 0xFF',
  'board_specific_info            = 0xAD',
  'mac_addr_format_version        = 0x01',
  'mac_block_count                = 0x8000',
  'mac_address                    = 3c:8c:93:a6:91:40',
...
cpu_cpld_old_bin =  CommonLib.get_swinfo_dict("CPU_CPLD").get("oldImage", "NotFound")
cpu_cpld_new_bin = CommonLib.get_swinfo_dict("CPU_CPLD").get("newImage", "NotFound")
...
sys_cpld_vme_image_old =  CommonLib.get_swinfo_dict("SYS_CPLD").get("oldImage", "NotFound")
sys_cpld_vme_image_new = CommonLib.get_swinfo_dict("SYS_CPLD").get("newImage", "NotFound")
