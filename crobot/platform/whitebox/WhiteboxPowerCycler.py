...
class WhiteboxPowerCycler(PowerCycler):

    def __init__(self, powerCyclerDict, powerCyclerPort):
        super().__init__(powerCyclerDict, powerCyclerPort)

        log.debug("Entering WhiteboxPowerCycler class procedure: __init__")
    ...
    def powerCycleDevice2(self):
        ...
        if 'Switched PDU' in self.managementPrompt:
            ...
            str1 = 'User Name'
            str2 = 'Password'
            str3 = 'successful' if not re.search('[0-9][0-9]',self.powerCyclerPort1[0]) else 'Success'
            on = 'olOn '
            off = 'olOff '
        else:
            str1 = 'Username'
