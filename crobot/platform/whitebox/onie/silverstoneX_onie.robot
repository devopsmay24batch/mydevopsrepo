...
Update_ONIE_via_Static_IP+TFTP
    ...
    independent_step  5  CheckInfoEqual  ${onie_version_now}  ${onie_version_1}  False
    independent_step  6  RebootToOnieMode  ${ONIE_UPDATE_MODE}
    ${onie_version_1_1}  GetOnieVersion
    independent_step  7  CheckInfoEqual  ${onie_version_1_1}  ${onie_version_1}
    ${onie_version_2}  UpdateOnie  new  ${PROTOCOL_TFTP}
    independent_step  8  CheckInfoEqual  ${onie_version_1}  ${onie_version_2}  False
    independent_step  9  Onie Disconnect Device
    [Teardown]  Run Keyword If Test Failed
    ...  Run Keywords
    ...  Onie Connect Device  AND
