...
get DUT variables Athena
    ...
    ${bmc_ipv4_ip} =  get_ip_address_from_ipmitool  DUT  eth_type=dedicated
    Set Environment Variable  bmc_ipv4_ip_1  ${bmc_ipv4_ip}
    Set Environment Variable  server_username_1  ${DUT_username}
    Set Environment Variable  server_ipv4_ip_1   ${DUT_ipv4_ip}
    Set Environment Variable  server_password_1   ${DUT_password} 
    ...
    ${DUT_password} =  get_password_from_config  UUT
    ${bmc_ipv4_ip} =  get_ip_address_from_ipmitool  DUT  eth_type=dedicated
    Set Environment Variable  bmc_ipv4_ip_2  ${bmc_ipv4_ip}
    Set Environment Variable  server_username_2  ${DUT_username}
    Set Environment Variable  server_ipv4_ip_2  ${DUT_ipv4_ip}
    Set Environment Variable  server_password_2   ${DUT_password}
    OS Disconnect Device
...
check BMC Version after mc reset cold ESMB
    Step  1  Keyword Retry  ssh_command_verify_bmc_version  %{server_username_2}  %{server_ipv4_ip_2}  %{server_password_2}
            ...  %{bmc_ipv4_ip_2}  ${bmc_username}  ${bmc_password}  ${remote}  ${BMC_version_ESMB}
    Step  2  Keyword Retry  ssh_command_verify_bmc_product_id  %{server_username_2}  %{server_ipv4_ip_2}  %{server_password_2}
            ...  %{bmc_ipv4_ip_2}  ${bmc_username}  ${bmc_password}  ${remote}  ${BMC_Product_ID}
    Step  3  Keyword Retry  ssh_command_verify_mc_reset  %{server_username_2}  %{server_ipv4_ip_2}  %{server_password_2}
            ...  %{bmc_ipv4_ip_2}  ${bmc_username}  ${bmc_password}  ${remote}  cold
    Step  4  set time delay  180
    Step  5  Keyword Retry  ssh_command_verify_bmc_version  %{server_username_2}  %{server_ipv4_ip_2}  %{server_password_2}
            ...  %{bmc_ipv4_ip_2}  ${bmc_username}  ${bmc_password}  ${remote}  ${BMC_version_ESMB}
    Step  6  Keyword Retry  ssh_command_verify_bmc_product_id  %{server_username_2}  %{server_ipv4_ip_2}  %{server_password_2}
            ...  %{bmc_ipv4_ip_2}  ${bmc_username}  ${bmc_password}  ${remote}  ${BMC_Product_ID}

check BMC Version after mc reset warm ESMB
    Step  1  Keyword Retry  ssh_command_verify_bmc_version  %{server_username_2}  %{server_ipv4_ip_2}  %{server_password_2}
            ...  %{bmc_ipv4_ip_2}  ${bmc_username}  ${bmc_password}  ${remote}  ${BMC_version_ESMB}
    Step  2  Keyword Retry  ssh_command_verify_bmc_product_id  %{server_username_2}  %{server_ipv4_ip_2}  %{server_password_2}
            ...  %{bmc_ipv4_ip_2}  ${bmc_username}  ${bmc_password}  ${remote}  ${BMC_Product_ID}
    Step  3  Keyword Retry  ssh_command_verify_mc_reset  %{server_username_2}  %{server_ipv4_ip_2}  %{server_password_2}
            ...  %{bmc_ipv4_ip_2}  ${bmc_username}  ${bmc_password}  ${remote}  warm
    Step  4  set time delay  180
    Step  5  Keyword Retry  ssh_command_verify_bmc_version  %{server_username_2}   %{server_ipv4_ip_2}  %{server_password_2}
            ...  %{bmc_ipv4_ip_2}  ${bmc_username}  ${bmc_password}  ${remote}  ${BMC_version_ESMB}
    Step  6  Keyword Retry  ssh_command_verify_bmc_product_id  %{server_username_2}  %{server_ipv4_ip_2}  %{server_password_2}
...
modify bmc lan static function Athena
    Step  1  modify_bmc_lan_ipsrc  DUT  ${lan_id}  ${ipsrc_mode_1}
    Step  2  modify_bmc_lan_ipaddr  DUT  ${lan_id}  ${ipaddr}
    Step  3  modify_bmc_lan_netmask  DUT  ${lan_id}  ${netmask}
    Step  4  set time delay  60
...
check COM0 BIOS settings Athena
    Step  1  run ipmi set cmd  DUT  cmd=${cmd_4_Set_System_Boot_Options}
    Step  2  run ipmi set cmd  DUT  cmd=${cmd_1_Set_System_Boot_Options}
    Step  3  run ipmi set cmd  DUT  cmd=${cmd_2_Set_System_Boot_Options}
    Step  4  run ipmi set cmd  DUT  cmd=${cmd_3_Set_System_Boot_Options}
    ...
    Step  6  reboot_os  DUT
    Step  7  set time delay  300
    Step  8  Set in BIOS Mode Athena  DUT
    Step  9  set time delay  180
    ${output} =  execute_local_cmd  ipmitool -I lanplus -H %{bmc_ipv4_ip_1} -U admin -P admin sol info
    common_check_patern_2    ${output}     115.2    verify ipmi set command   expect=True

User Privilege Check Athena A
    ${output} =  execute_Linux_command   ${cmd_Get_Channel_Access}
    common_check_patern_2    ${output}     04      verify get privilege   expect=True
    execute_Linux_command   ipmitool user set name 3 tester
    execute_Linux_command   ipmitool user set password 3 test123456789012
    execute_Linux_command   ipmitool user enable 3
    execute_Linux_command   ipmitool raw 6 0x43 0x91 3 4 0
    ${output} =  execute_Linux_command   time ipmitool user priv 3 04 1
    common_check_patern_2    ${output}     successful    Setting Administrator privilege   expect=True
    ${output} =  execute_local_cmd  ipmitool -L administrator -H %{bmc_ipv4_ip_1} -U tester -P test123456789012 user set name 6 sky
    common_check_patern_2    ${output}     normal    verify ipmi set command   expect=True
    ${output} =  execute_local_cmd  ipmitool -L administrator -H %{bmc_ipv4_ip_1} -U tester -P test123456789012 raw 6 0x24 01 03 00 0x3e 0x58 02
    common_check_patern_2    ${output}     normal    verify ipmi set command   expect=True
    ${output} =  execute_local_cmd  ipmitool -L administrator -H %{bmc_ipv4_ip_1} -U tester -P test123456789012 raw 6 0x22
    common_check_patern_2    ${output}     normal    verify ipmi set command   expect=True
    ${output} =  execute_local_cmd  ipmitool -L administrator -H %{bmc_ipv4_ip_1} -U tester -P test123456789012 raw 6 0x25
    common_check_patern_2    ${output}     normal    verify ipmi set command   expect=True
    ${output} =  execute_Linux_command   time ipmitool user priv 3 03 1
    common_check_patern_2    ${output}     successful    Setting operator privilege   expect=True
    ${output} =  execute_local_cmd  ipmitool -L administrator -H %{bmc_ipv4_ip_1} -U tester -P test123456789012 user set name 6 sky
    common_check_patern_2    ${output}     Unable to establish    verify ipmi set command   expect=True
    ${output} =  execute_local_cmd  ipmitool -L administrator -H %{bmc_ipv4_ip_1} -U tester -P test123456789012 raw 6 0x24 01 03 00 0x3e 0x58 02
    common_check_patern_2    ${output}     normal    verify ipmi set command   expect=True
    ${output} =  execute_local_cmd  ipmitool -L administrator -H %{bmc_ipv4_ip_1} -U tester -P test123456789012 raw 6 0x22
    common_check_patern_2    ${output}     normal    verify ipmi set command   expect=True
    ${output} =  execute_local_cmd  ipmitool -L administrator -H %{bmc_ipv4_ip_1} -U tester -P test123456789012 raw 6 0x25
    common_check_patern_2    ${output}     normal    verify ipmi set command   expect=True
    ${output} =  execute_Linux_command   time ipmitool user priv 3 02 1
    common_check_patern_2    ${output}     successful    Setting operator privilege   expect=True
    ${output} =  execute_local_cmd  ipmitool -L administrator -H %{bmc_ipv4_ip_1} -U tester -P test123456789012 user set name 6 sky
    common_check_patern_2    ${output}     establish fail    verify ipmi set command   expect=True
    ${output} =  execute_local_cmd  ipmitool -L administrator -H %{bmc_ipv4_ip_1} -U tester -P test123456789012 raw 6 0x24 01 03 00 0x3e 0x58 02
    common_check_patern_2    ${output}     establish fail    verify ipmi set command   expect=True
    ${output} =  execute_local_cmd  ipmitool -L administrator -H %{bmc_ipv4_ip_1} -U tester -P test123456789012 raw 6 0x22
    common_check_patern_2    ${output}     establish fail    verify ipmi set command   expect=True
...
User Privilege Check Athena B
    ...
    ${output} =  execute_Linux_command   time ipmitool user priv 3 04 1
    common_check_patern_2    ${output}     successful    Setting Administrator privilege   expect=True
    ${output} =  execute_local_cmd  ipmitool -L administrator -H %{bmc_ipv4_ip_2} -U tester -P test123456789012 user set name 6 sky
    common_check_patern_2    ${output}     normal    verify ipmi set command   expect=True
    ${output} =  execute_local_cmd  ipmitool -L administrator -H %{bmc_ipv4_ip_2} -U tester -P test123456789012 raw 6 0x24 01 03 00 0x3e 0x58 02
    common_check_patern_2    ${output}     normal    verify ipmi set command   expect=True
    ${output} =  execute_local_cmd  ipmitool -L administrator -H %{bmc_ipv4_ip_2} -U tester -P test123456789012 raw 6 0x22
    common_check_patern_2    ${output}     normal    verify ipmi set command   expect=True
    ${output} =  execute_local_cmd  ipmitool -L administrator -H %{bmc_ipv4_ip_2} -U tester -P test123456789012 raw 6 0x25
    common_check_patern_2    ${output}     normal    verify ipmi set command   expect=True
    ${output} =  execute_Linux_command   time ipmitool user priv 3 03 1
    common_check_patern_2    ${output}     successful    Setting operator privilege   expect=True
    ${output} =  execute_local_cmd  ipmitool -L administrator -H %{bmc_ipv4_ip_2} -U tester -P test123456789012 user set name 6 sky
...
check BMC POH status after BMC FW update Athena A
    set time delay  1800
    FOR    ${INDEX}    IN RANGE    1    ${MaxLoopNum}
        Print Loop Info  ${INDEX}
        ${time_before} =  get_poh_counter  DUT
        ...
        ${BMC_MAC_address1a}  get_info_from_lan_print  DUT  MAC Address  True  ${ip}
        OS Disconnect Device
        updateBMCfirmwarefromremoteclient  DUT  ${ip}  Athena_FW_BMC_A  upgrade  1
        Sleep  500
        OS Connect Device
        ${ip}  get_ip_address_from_ipmitool  DUT
        OS Disconnect Device
        updateBMCfirmwarefromremoteclient  DUT  ${ip}  Athena_FW_BMC_A  upgrade  2
        Sleep  500
        OS Connect Device
        verifysystemafterFWupdate  Athena_FW_BMC_A  upgrade  ${ip}  ${BMC_MAC_address1a}
        Sleep  150
        ${time_after} =  get_poh_counter  DUT
        verify_poh_counter  ${time_before}  ${time_after}
    END

check BMC POH status after BMC FW update Athena B
    set time delay  1800
    FOR    ${INDEX}    IN RANGE    1    ${MaxLoopNum}
        Print Loop Info  ${INDEX}
        ${time_before} =  get_poh_counter  DUT
...
Power Control Check Athena A
    execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_1} -U admin -P admin sel clear
    execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_1} -U admin -P admin raw 00 02 00
    ${output_off} =  execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_1} -U admin -P admin power status
    common_check_patern_2    ${output_off}    Chassis Power is off   verify power status off   expect=True
    Verify the SEL and ensure no error
    Verify abnormal event log  DUT  %{bmc_ipv4_ip_1}
    execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_1} -U admin -P admin sel clear
    execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_1} -U admin -P admin raw 00 02 01
    ${output_on} =  execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_1} -U admin -P admin power status
    common_check_patern_2    ${output_on}   Chassis Power is on  verify power status on   expect=True
    Sleep  60
    wait_prompt  DUT
    Verify the SEL and ensure no error
    Verify abnormal event log  DUT  %{bmc_ipv4_ip_1}
    execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_1} -U admin -P admin sel clear
    execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_1} -U admin -P admin raw 00 02 02
    ${output_off} =  execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_1} -U admin -P admin power status
    common_check_patern_2    ${output_off}    Chassis Power is on   verify power status   expect=True
    Sleep  60
    wait_prompt  DUT
    Verify the SEL and ensure no error
    Verify abnormal event log  DUT  %{bmc_ipv4_ip_1}
    execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_1} -U admin -P admin sel clear
    execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_1} -U admin -P admin raw 00 02 03
    ${output_off} =  execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_1} -U admin -P admin power status
    common_check_patern_2    ${output_off}    Chassis Power is on   verify power status   expect=True
    Sleep  60
    wait_prompt  DUT
    ...
    Verify abnormal event log  DUT  %{bmc_ipv4_ip_1}
    execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_1} -U admin -P admin sel clear
    execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_1} -U admin -P admin raw 00 02 05
    ${output_off} =  execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_1} -U admin -P admin power status
    common_check_patern_2    ${output_off}    Chassis Power is on   verify power status   expect=True
    Sleep  60
    wait_prompt  DUT
...
Power Control Check Athena B
    execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_2} -U admin -P admin sel clear
    execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_2} -U admin -P admin raw 00 02 00
    ${output_off} =  execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_2} -U admin -P admin power status
    common_check_patern_2    ${output_off}    Chassis Power is off   verify power status   expect=True
    Verify the SEL and ensure no error
    Verify abnormal event log  DUT  %{bmc_ipv4_ip_2}
    execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_2} -U admin -P admin sel clear
    execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_2} -U admin -P admin raw 00 02 01
    ${output_on} =  execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_2} -U admin -P admin power status
    common_check_patern_2    ${output_on}   Chassis Power is on  verify power status   expect=True
    Sleep  60
    wait_prompt  DUT
    Verify the SEL and ensure no error
    Verify abnormal event log  DUT  %{bmc_ipv4_ip_2}
    execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_2} -U admin -P admin sel clear
    execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_2} -U admin -P admin raw 00 02 02
    ${output_off} =  execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_2} -U admin -P admin power status
    common_check_patern_2    ${output_off}    Chassis Power is on   verify power status   expect=True
    Sleep  60
    wait_prompt  DUT
    ...
    Verify abnormal event log  DUT  %{bmc_ipv4_ip_2}
    execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_2} -U admin -P admin sel clear
    execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_2} -U admin -P admin raw 00 02 03
    ${output_off} =  execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_2} -U admin -P admin power status
    common_check_patern_2    ${output_off}    Chassis Power is on   verify power status   expect=True
    Sleep  60
    wait_prompt  DUT
    ...
    Verify abnormal event log  DUT  %{bmc_ipv4_ip_2}
    execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_2} -U admin -P admin sel clear
    execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_2} -U admin -P admin raw 00 02 05
    ${output_off} =  execute_local_cmd   ipmitool -I lanplus -H %{bmc_ipv4_ip_2} -U admin -P admin power status
    common_check_patern_2    ${output_off}    Chassis Power is on   verify power status   expect=True
    Sleep  60
    wait_prompt  DUT
