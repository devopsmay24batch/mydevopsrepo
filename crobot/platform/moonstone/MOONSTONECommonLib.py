...
class MOONSTONELib():
    def __init__(self):
        log.debug("Entering MoonstoneCommonLib class procedure: __init__")
        import DeviceMgr
        self.device = DeviceMgr.getDevice()

    def loginDevice(self):
        log.debug("Entering MoonstoneCommonLib class procedure: login")
    ...
    def loginDevice1(self):
        log.debug("Entering MoonstoneCommonLib class procedure: login for BMC")
...
def DiagOSConnect():
    log.debug("Entering MoonstoneCommonLib class procedure: DiagOSConnect")
    device.loginDiagOS()
...
def DiagOSDisconnect():
    global libObj
    log.debug("Entering MoonstoneCommonLib class procedure: DiagOSDisconnect")
    device.disconnect()
    return
...
def OSConnect():
    global libObj
    log.debug("Entering MoonstoneCommonLib class procedure: OSConnect")
    libObj = MOONSTONELib()
    libObj.loginDevice()
    return
...
def ConnectESMB():
    global libObj
    log.debug("Entering MoonstoneCommonLib class procedure: ConnectESMB")
    libObj = MOONSTONELib()
    libObj.loginDevice1()
    return
...
def OSDisconnect():
    global libObj
    log.debug("Entering MoonstoneCommonLib class procedure: OSDisconnect")
    libObj.disconnectDevice()
    return
                                                  

def powerCycleToDiagOS():
    log.debug("Entering MoonstoneCommonLib class procedure: powerCycleToDiagOS")
    return device.powerCycleToMode(Const.BOOT_MODE_DIAGOS)

def powerCycleToUboot():
    log.debug("Entering MoonstoneCommonLib class procedure: powerCycleToUboot")
    return device.powerCycleToMode(Const.BOOT_MODE_UBOOT)

def powerCycleToOnieRescueMode():
    log.debug("Entering MoonstoneCommonLib class procedure: powerCycleToOnieRescueMode")
    return device.powerCycleToMode(Const.ONIE_RESCUE_MODE)

def powerCycleToOnieInstallMode():
    log.debug("Entering MoonstoneCommonLib class procedure: powerCycleToOnieInstallMode")
    return device.powerCycleToMode(Const.ONIE_INSTALL_MODE)

def powerCycleToOnieUpdateMode():
    log.debug("Entering MoonstoneCommonLib class procedure: powerCycleToOnieUpdateMode")
    return device.powerCycleToMode(Const.ONIE_UPDATE_MODE)

def bootIntoDiagOSMode():
    log.debug("Entering MoonstoneCommonLib class procedure: bootIntoDiagOSMode")
    return device.getPrompt(Const.BOOT_MODE_DIAGOS)

def bootIntoUboot():
    log.debug("Entering MoonstoneCommonLib class procedure: bootIntoUboot")
    return device.getPrompt(Const.BOOT_MODE_UBOOT)

def bootIntoOnieInstallMode():
    log.debug("Entering MoonstoneCommonLib class procedure: bootIntoOnieInstallMode")
    return device.getPrompt(Const.ONIE_INSTALL_MODE)

def bootIntoOnieUpdateMode():
    log.debug("Entering MoonstoneCommonLib class procedure: bootIntoOnieUpdateMode")
    return device.getPrompt(Const.ONIE_UPDATE_MODE)

def bootIntoOnieRescueMode():
    log.debug("Entering MoonstoneCommonLib class procedure: bootIntoOnieRescueMode")
...
def run_command(cmd, deviceObj=None, prompt=None, timeout=60, CR=True):
    log.debug("Entering MoonstoneCommonLib class procedure: run_command")
...
@logThis
def check_server_moonstone(device, host_ip, host_name, host_passwd, server_prompt):
    deviceObj = Device.getDeviceObject(device)
