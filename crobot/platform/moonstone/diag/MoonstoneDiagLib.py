...
#import MoonstoneConst
import Const
import time
import MOONSTONECommonLib 
from collections import OrderedDict
import MoonstoneDiagVariable as var
from  MOONSTONECommonLib import powerCycle
...
def diag_installation(image):
    ...
    run_command('rm *')
    wget_cmd = "wget http://10.208.84.203/MOONSTONE/DVT/R4028-J0001-01_moonstone_diag_release.v3.3.0.deb"
...
def goToDiagPath(subdir='bin'):
    path='/home/cel_diag/moonstone/' + subdir
    str1= 'cd ' +path
...
def check_upgrade_test(dev,module,image,img_version,devId):
    ...
    get_img_path = 'cd /home/cel_diag/moonstone/firmware/' + module
    ...
    if devId == '2':
        cmd = device.executeCmd("/home/cel_diag/moonstone/tools/lpc_cpld_x86_64 blu r 0xA100")
        version = re.search('\n(0x\S+)\r\s+',cmd)
...
def check_eeprom_test():
    ...
    c2=device.executeCmd('./cel-eeprom-test -w -A 21 -D moonstone')
...
@logThis
def go_to_fru():
    device.executeCmd('cd /diag/home/cel_diag/moonstone/firmware/fru_eeprom/')
