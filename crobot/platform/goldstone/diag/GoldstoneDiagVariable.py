...
image_path ='/GOLDSTONE/'
GOLDSTONE = SwImage.getSwImage("GOLDSTONE_DIAG")
diag_image = GOLDSTONE.newImage
diag_version = GOLDSTONE.newVersion

old_image = GOLDSTONE.oldImage
old_version = GOLDSTONE.oldVersion



baseVersion = CommonLib.get_swinfo_dict("GOLDSTONE_DIAG")
