...
class GOLDSTONEDevice(Device):

    def __init__(self, deviceDict):
        super().__init__(deviceDict)
        log.debug("Entering Goldstone Device class procedure: __init__")
        self.using_pem = -1
    ...
    def loginDiagOS(self):
        log.debug("Entering Goldstone Device class procedure: loginDiagOS")
        try:
