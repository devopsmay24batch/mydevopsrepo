...
*** Settings ***
Documentation     Kapok briggs BSP suite

Variables         kapok/KapokBspBgVariablesLatest.py
...
BSP_TC11_Port_Module_Interrupt_Test
    ...
    [Tags]     common  BSP_TC11_Port_Module_Interrupt_Test  briggs
...
BSP_TC12_Port_Module_Present_Test
    ...
    [Tags]     BSP_TC12_Port_Module_Present_Test  briggs
...
BSP_TC13_Port_Module_Reset_Test
    ...
    [Tags]     BSP_TC13_Port_Module_Reset_Test  briggs
    [Timeout]  2 min 00 seconds
    ...
    Step  4  modify reset file value  path=${interrupt_port_file_path}  pre=${reset_file_pre}  suf=${reset_file_suf}  value=${port_module_reset_value}
    Step  5  cat loop file info  path=${interrupt_port_file_path}  pre=${reset_file_pre}  suf=${reset_file_suf}  passpattern=${reset_passpattern_list1}


BSP_TC14_Port_Module_Lpmod_Test
    [Documentation]  This test is to check the optical module power mode
    [Tags]     BSP_TC14_Port_Module_Lpmod_Test  briggs
    [Timeout]  2 min 00 seconds
    Step  1  cat loop file info  path=${interrupt_port_file_path}  pre=${lpmod_file_pre}  suf=${lpmod_file_suf}  passpattern=${lpmod_passpattern_list2}
    Step  2  modify reset file value  path=${interrupt_port_file_path}  pre=${lpmod_file_pre}  suf=${lpmod_file_suf}  value=${lpmod_reset_value}
    Step  3  cat loop file info  path=${interrupt_port_file_path}  pre=${lpmod_file_pre}  suf=${lpmod_file_suf}  passpattern=${lpmod_passpattern_list1}
    [Teardown]  Modify And Verify File Value  ${interrupt_port_file_path}  ${lpmod_file_pre}  ${lpmod_file_suf}  ${lpmod_passpattern_list2}  ${lpmod_default_value}


BSP_TC18_PSU_Voltage_Fault_Test
    [Documentation]  this test is to check PSU voltage fault status
    [Tags]     BSP_TC18_PSU_Voltage_Fault_Test  briggs
...
BSP_TC19_PSU_Voltage_Up_Test
    ...
    [Tags]     BSP_TC19_PSU_Voltage_Up_Test  briggs
    [Timeout]  1 min 00 seconds
...
BSP_TC43_Fan_Direction_Test
    ...
    Step  2  cat loop file info  ${device_31_0066_path}  ${fan_direction_file_pre}  ${fan_direction_file_suf}  14  ${fan_direction_passpattern}  1

BSP_TC44_FAN_INPUT_TEST
    [Tags]  BSP_TC44_FAN_INPUT_TESTs
    ...  briggs  fenghuang  shenzhou  tigris

    [Setup]  force unload/load all kernel driver matched with *.ko file

    Step  1  read FAN input by file system attribute
    Step  2  read FAN input by diagtool
    Step  3  compare FAN input
...
BSP_TC45_Fan_Label_Test
    ...
    Step  3  verify fan label info  ${device_31_0066_path}  ${fan_label_file_pre}  ${fan_label_file_suf}  ${fan_label_pattern1_pre}  ${fan_label_pattern1_suf}
    Step  4  verify fan label info  ${device_31_0066_path}  ${fan_label_file_pre}  ${fan_label_file_suf}  ${fan_label_pattern2_pre}  ${fan_label_pattern2_suf}  2
...
BSP_TC47_Fan_max_Speed(RPM)_Test
    ...
    Step  2  cat loop file info  ${device_31_0066_path}  ${fan_max_speed_path_pre}  ${fan_max_speed_path_suf}  14  ${fan_max_speed_passpattern1}
    Step  3  modify reset file value  ${device_5_0066_path}  ${fan_max_speed_path_pre}  ${fan_max_speed_path_suf}  ${echo_max_speed}  14
    Step  4  modify reset file value  ${device_31_0066_path}  ${fan_max_speed_path_pre}  ${fan_max_speed_path_suf}  ${echo_max_speed}  14
    Step  5  cat loop file info  ${device_5_0066_path}  ${fan_max_speed_path_pre}  ${fan_max_speed_path_suf}  14  ${fan_max_speed_passpattern2}
    Step  6  cat loop file info  ${device_31_0066_path}  ${fan_max_speed_path_pre}  ${fan_max_speed_path_suf}  14  ${fan_max_speed_passpattern2}
...
BSP_TC48_Fan_min_Speed(RPM)_Test
    ...
    Step  2  cat loop file info  ${device_31_0066_path}  ${fan_min_speed_path_pre}  ${fan_min_speed_path_suf}  14  ${fan_min_speed_passpattern1}
    Step  3  modify reset file value  ${device_5_0066_path}  ${fan_min_speed_path_pre}  ${fan_min_speed_path_suf}  ${echo_min_speed}  14
    Step  4  modify reset file value  ${device_31_0066_path}  ${fan_min_speed_path_pre}  ${fan_min_speed_path_suf}  ${echo_min_speed}  14
    Step  5  cat loop file info  ${device_5_0066_path}  ${fan_min_speed_path_pre}  ${fan_min_speed_path_suf}  14  ${fan_min_speed_passpattern2}
    Step  6  cat loop file info  ${device_31_0066_path}  ${fan_min_speed_path_pre}  ${fan_min_speed_path_suf}  14  ${fan_min_speed_passpattern2}
    Step  7  modify reset file value  ${device_5_0066_path}  ${fan_min_speed_path_pre}  ${fan_min_speed_path_suf}  ${echo_min_default}  14
    Step  8  modify reset file value  ${device_31_0066_path}  ${fan_min_speed_path_pre}  ${fan_min_speed_path_suf}  ${echo_min_default}  14

BSP_TC49_Fan_Present_Test
    [Documentation]  This test is to check current present status of fan module
    [Tags]     BSP_TC49_Fan_Present_Test  briggs
    [Timeout]  2 min 00 seconds
    Step  1  cat loop file info  ${device_5_0066_path}  ${fan_present_file_pre}  ${fan_present_file_suf}  14  ${fan_present_passpattern}
    Step  2  cat loop file info  ${device_31_0066_path}  ${fan_present_file_pre}  ${fan_present_file_suf}  14  ${fan_present_passpattern}
...
BSP_TC65_UBOOT_MGMT_TFTP_STRESS_TEST
    ...
    Step  6   U-Boot sleep
    Step  7   U-Boot renew DHCP/IP
    Step  8   U-Boot setenv  env=serverip ${tftp_server_ipv4}
    Step  9   U-Boot tftpboot
    Step  10  U-Boot reset

*** Keywords ***
Modify And Verify File Value
    [Arguments]  ${path}  ${pre}  ${suf}  ${passpattern}  ${value}

    modify reset file value  ${path}  ${pre}  ${suf}  ${value}

    cat loop file info  path=${path}  pre=${pre}  suf=${suf}  passpattern=${passpattern}
