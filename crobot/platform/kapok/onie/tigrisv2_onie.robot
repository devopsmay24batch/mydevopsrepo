...
ONIE_TC_000_Onie_Initialize_And_Version_Check
    ...
    [Tags]  ONIE_TC_000_Onie_Initialize_And_Version_Check  tigrisv2
...
ONIE_TC_001_Install_ONIE_via_Flashcp_on_ONIE
    ...
    [Tags]  common  ONIE_TC_001_Install_ONIE_via_Flashcp_on_ONIE  tigrisv2
...
ONIE_TC_002_Install_ONIE_Nor_flash_by_TFTP_Test
    ...
    [Tags]  common  ONIE_TC_002_Install_ONIE_Nor_flash_by_TFTP_Test  tigrisv2
    [Timeout]  20 min 00 seconds
...
ONIE_TC_003_Install_ONIE_via_Flashcp_on_DiagOS
    [Documentation]  This test checks the Installing ONIE via Flashcp on DiagOS
    [Tags]  common  ONIE_TC_003_Install_ONIE_via_Flashcp_on_DiagOS  tigrisv2
...
ONIE_TC_004_ONIE_Update_via_Static_IP+TFTP
    ...
    [Tags]  common  ONIE_TC_004_ONIE_Update_via_Static_IP+TFTP  tigrisv2
...
ONIE_TC_005_ONIE_Update_via_DHCP_IP+TFTP
    ...
    [Tags]  common  ONIE_TC_005_ONIE_Update_via_DHCP_IP+TFTP  tigrisv2
    [Timeout]  60 min 00 seconds
...
ONIE_TC_006_ONIE_Update_via_noforce_on_ONIE
    ...
    [Tags]  common  ONIE_TC_006_ONIE_Update_via_noforce_on_ONIE  tigrisv2
    [Setup]  boot into Onie Rescue Mode
...
ONIE_TC_007_ONIE_Update_via_image_self
    ...
    [Tags]  ONIE_TC_007_ONIE_Update_via_image_self   tigrisv2  try
    [Timeout]  60 min 00 seconds
    [Setup]  boot Into Onie Rescue Mode
...
ONIE_TC_008_ONIE_Update_via_image_self_noforce
	[Documentation]  This test is to verify that ONIE can be updated via image self noforce
    [Tags]  ONIE_TC_008_ONIE_Update_via_image_self_noforce  tigrisv2
    [Setup]   boot into Onie Rescue Mode
    Step  1  check onie latest version
...
ONIE_TC_009_ONIE_Update_With_Current_Version
    ...
    [Tags]  common  ONIE_TC_009_ONIE_Update_With_Current_Version  tigrisv2
...
ONIE_TC_010_ONIE_Update_With_Higher_Version
    ...
    [Tags]  common  ONIE_TC_010_ONIE_Update_With_Higher_Version  tigrisv2
    [Timeout]  60 min 00 seconds
    [Setup]  boot into Onie Rescue Mode
	Step  1  check onie latest version
...
ONIE_TC_011_ONIE_Update_With_Production_Version
    ...
    [Tags]  common  ONIE_TC_011_ONIE_Update_With_Production_Version  tigrisv2
    [Timeout]  60 min 00 seconds
    [Setup]  boot into Onie Rescue Mode
	Step  1  check onie latest version
...
ONIE_TC_012_ONIE_Update_With_Customer_Version
    ...
    [Tags]  common  ONIE_TC_012_ONIE_Update_With_Customer_Version  tigrisv2
    [Timeout]  60 min 00 seconds
    [Setup]  boot into Onie Rescue Mode
	Step  1  check onie latest version
...
ONIE_TC_013_ONIE_NOS_Install_via_Static_IP_TFTP
    ...
    [Tags]   ONIE_TC_013_ONIE_NOS_Install_via_Static_IP_TFTP   tigrisv2
    [Timeout]  60 min 00 seconds
...
ONIE_TC_014_ONIE_NOS_Install_via_DHCP_IP_TFTP
    ...
    [Tags]   ONIE_TC_014_ONIE_NOS_Install_via_DHCP_IP_TFTP   tigrisv2
	[Setup]  boot into DiagOS mode
    Step  1  get dhcp ip and ping server
...
ONIE_TC_015_ERASE_ONIE
    ...
    [Tags]  common  ONIE_TC_015_ERASE_ONIE  tigrisv2
...
ONIE_TC_016_ONIE_Booting_Mode_Check
    ...
    [Tags]  common  ONIE_TC_016_ONIE_Booting_Mode_Check  tigrisv2
    [Timeout]  60 min 00 seconds
...
ONIE_TC_017_ONIE_System_Information
    ...
    [Tags]  common  ONIE_TC_017_ONIE_System_Information  tigrisv2
    [Timeout]  5 min 00 seconds
    [Setup]  boot Into Onie Install Mode
    Step  1  check onie tlv and some sys info  ${ONIE_SYSEEPROM_CMD}  ${SYS_INFO_LST}
    Step  2  check psu info
    Step  3  check temp info  ${TEMP_INFO_TOOL}
    Step  4  check fan info
    Step  5  check onie initargs and bootargs  ${initargs_tool}  ${bootargs_tool}  ${initargs_res}  ${bootargs_res}

ONIE_TC_018_TLV_EEPROM_R/W_Test
    [Documentation]  This test checks TLV EEPROM can be read/write successfully in ONIE
    [Tags]  common  ONIE_TC_018_TLV_EEPROM_R/W_Test  tigrisv2
    [Timeout]  20 min 00 seconds
    [Setup]  boot into Onie Rescue Mode
...
ONIE_TC_019_Auto_Discovery_Rescue_Mode
    ...
    [Tags]  common  ONIE_TC_019_Auto_Discovery_Rescue_Mode  tigrisv2
    [Timeout]  20 min 00 seconds
...
ONIE_TC_020_CPLD/FPGA_Updates
    ...
    [Tags]  common  ONIE_TC_020_CPLD/FPGA_Updates  tigrisv2
    [Timeout]  60 min 00 seconds
...
ONIE_10.7.12_Serial_Console_Access
    ...
    [Tags]  common  ONIE_10.7.12_Serial_Console_Access  tigrisv2
    [Timeout]  5 min 00 seconds
    [Setup]  boot Into Onie Install Mode
...
ONIE_10.7.13_ONIE_Diag_OS_recovery_Test
    ...
    [Tags]  common  ONIE_10.7.13_ONIE_Diag_OS_recovery_Test  tigrisv2
    [Timeout]  20 min 00 seconds
    Step  1  boot Into Onie Rescue Mode
    Step  2  Check network connectivity  ${ONIE_RESCUE_MODE}
    Step  3  format Disk
...
ONIE_10.7.14_File_system_ext3/ext4_Supports
    ...
    [Tags]  common  ONIE_10.7.14_File_system_ext3/ext4_Supports  tigrisv2
    [Timeout]  20 min 00 seconds
    Step  1  boot Into Onie Rescue Mode
...
ONIE_10.7.15_File_System_Utilities_Test
    ...
    [Tags]  common  ONIE_10.7.15_File_System_Utilities_Test  tigrisv2
    [Timeout]  20 min 00 seconds
    Step  1  boot Into Onie Rescue Mode
...
ONIE_10.7.16_Default_file_Name_Search_Order
    ...
    [Tags]  common  ONIE_10.7.16_Default_file_Name_Search_Order  tigrisv2
    [Timeout]  30 min 00 seconds
...
ONIE_10.7.17_Installer_Discovery_Methods
    ...
    [Tags]  common  ONIE_10.7.17_Installer_Discovery_Methods  tigrisv2
    [Timeout]  20 min 00 seconds
    [Setup]  boot Into Onie Install Mode
...
ONIE_10.7.18_Uboot_Environment_Access
    ...
    [Tags]  common  ONIE_10.7.18_Uboot_Environment_Access  tigrisv2
    [Timeout]  20 min 00 seconds
	Step  1  boot Into Onie Rescue Mode
...
ONIE_10.7.19_SSD_Device_Health_Status
    ...
    [Tags]  common  ONIE_10.7.19_SSD_Device_Health_Status  tigrisv2
    [Timeout]  5 min 00 seconds
    [Setup]  boot Into Onie Install Mode
...
ONIE_10.7.20_FSC_Check_Test
    ...
    [Tags]  common  ONIE_10.7.20_FSC_Check_Test  tigrisv2
...
ONIE_10.7.21_QSFP_Access_Test
    ...
    [Tags]  common  ONIE_10.7.21_QSFP_Access_Test  tigrisv2
    [Timeout]  5 min 00 seconds
    [Setup]  boot Into Onie Install Mode
...
ONIE_10.7.22_Check_Driver_Information_in_ONIE
    ...
    [Tags]  common  ONIE_10.7.22_Check_Driver_Information_in_ONIE  tigrisv2
    [Timeout]  20 min 00 seconds
...
ONIE_10.7.23_Check_onie_Platform_Information_in_uboot
    ...
    [Tags]  common  ONIE_10.7.23_Check_onie_Platform_Information_in_uboot  tigrisv2
    [Timeout]  20 min 00 seconds
    [Setup]  boot Into Uboot
...
ONIE_10.7.24_FPP_Modes_Test
    ...
    [Tags]  common  ONIE_10.7.24_FPP_Modes_Test  tigrisv2
    [Timeout]  50 min 00 seconds
...
ONIE_10.7.25_Integrator_Mode_Test
    ...
    [Tags]  common  ONIE_10.7.25_Integrator_Mode_Test  tigrisv2
    [Timeout]  20 min 00 seconds
    [Setup]  boot Into Onie Install Mode
...
ONIE_10.7.26_SFP_Test
    ...
    [Tags]  common  ONIE_10.7.26_SFP_Test  tigrisv2
    [Timeout]  10 min 00 seconds
	[Setup]  boot Into Onie Install Mode
...
ONIE_11.3_ONIE_Updater_Stress_Test
    ...
    [Tags]  common  ONIE_11.3_ONIE_Updater_Stress_Test  tigrisv2
