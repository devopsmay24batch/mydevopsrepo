...
sdk_SW = 'R3152-m0165-01-SDK_brixia.v'+sdk_version+'_sonic202012.deb'
...
bcm_sdk_version='sdk-6.5.24'
come_cpld_version = ['0x17']
mmc_major_version = ['0x00']
mmc_minor_version = ['0x0b']
mmc_month_version = ['0x12']
mmc_date_version = ['0x17']
...
pcie_log = ['01:00.0 Ethernet controller: Broadcom Limited Device b996.*',
        '08:00.0 System peripheral: Google, Inc. Device 0065']

th4_pci = '01:00.0 Ethernet controller: Broadcom Limited Device b996'
th4_pci_speed_width = 'Speed 8GT/s, Width x4'

gfpga_pci = '08:00.0 System peripheral: Google, Inc. Device 0065'
...
cmd9 = ['/sys/devices/platform/mmcpld/fantray.6.auto/hwmon/hwmon10',
        ...
        '/sys/devices/platform/mmcpld/fantray.6.auto/hwmon/hwmon12',
